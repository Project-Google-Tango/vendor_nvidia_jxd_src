...
############ some local flags
# If you change any of those flags, you need to rebuild both libjni_nvlatinime_common_static
# and the shared library that uses libjni_nvlatinime_common_static.
FLAG_DBG ?= false
...
LATIN_IME_JNI_SRC_FILES := \
    com_nvidia_inputmethod_keyboard_ProximityInfo.cpp \
    com_nvidia_inputmethod_latin_BinaryDictionary.cpp \
    com_nvidia_inputmethod_latin_DicTraverseSession.cpp \
    jni_common.cpp
...
LOCAL_MODULE := libjni_nvlatinime_common_static
...
LOCAL_WHOLE_STATIC_LIBRARIES := libjni_nvlatinime_common_static
...
LOCAL_MODULE := libjni_nvlatinime
LOCAL_MODULE_TAGS := optional
