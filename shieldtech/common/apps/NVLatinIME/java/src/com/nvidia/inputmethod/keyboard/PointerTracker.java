...
import com.nvidia.inputmethod.keyboard.internal.GestureStroke;
import com.nvidia.inputmethod.keyboard.internal.GestureStroke.GestureStrokeParams;
import com.nvidia.inputmethod.keyboard.internal.GestureStrokeWithPreviewPoints;
import com.nvidia.inputmethod.keyboard.internal.PointerTrackerQueue;
...
public final class PointerTracker implements PointerTrackerQueue.Element {
    ...
    public void processMotionEvent(final int action, final int x, final int y, final long eventTime,
        ...
        processMotionEvent(action, x, y, eventTime, handler, null);
    }

    public void processMotionEvent(int action, int x, int y, long eventTime,
            KeyEventHandler handler, Keyboard keyboard) {
        switch (action) {
        case MotionEvent.ACTION_DOWN:
        case MotionEvent.ACTION_POINTER_DOWN:
            onDownEvent(x, y, eventTime, handler, keyboard);
            break;
    ...
    public void onDownEvent(final int x, final int y, final long eventTime,
            final KeyEventHandler handler, Keyboard keyboard) {
        if (DEBUG_EVENT) {
        ...
        onDownEventInternal(x, y, eventTime, keyboard);
    ...
    private void onDownEventInternal(final int x, final int y, final long eventTime, Keyboard keyboard) {
            ...
            if (oldKey == null) {
                ...
                if (mIsAllowedSlidingKeyInput) {
                    ...
                    if (sNeedsPhantomSuddenMoveEventHack
                        ...
                        onDownEventInternal(x, y, eventTime, null);
                    }
    ...
    public void onShowMoreKeysPanel(final int x, final int y, final KeyEventHandler handler) {
        ...
        onDownEvent(x, y, SystemClock.uptimeMillis(), handler, null);
    }
