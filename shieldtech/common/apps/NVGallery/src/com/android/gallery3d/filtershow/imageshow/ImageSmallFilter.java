...
public class ImageSmallFilter extends ImageShow implements View.OnClickListener {
    ...
    private boolean mUseDefaultBehaviorOnClick = false;

    public void setDefaultBehaviorOnClick(boolean b) {
        mUseDefaultBehaviorOnClick = b;
    }
    ...
    public void onClick(View v) {
        if (mUseDefaultBehaviorOnClick) {
            ...
            if (mController != null) {
                if (mImageFilter != null) mController.useImageFilter(this, mImageFilter, mSetBorder);
                else if (mImagePreset != null) mController.useImagePreset(this, mImagePreset);
            }
        }
    }
