...
public class PhotoPageBottomControls implements OnClickListener, OnFocusChangeListener {
    ...
    public void onFocusChange(View view, boolean hasFocus) {
        if (hasFocus && mContainerVisible && mControlsVisible.get(view).booleanValue()) {
