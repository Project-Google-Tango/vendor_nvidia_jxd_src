...
public class MovieActivity extends Activity {
    ...
    private static final String HIDE_ACTION_BAR = "com.android.gallery3d.EXTRA_HIDE_ACTION_BAR";
    ...
    private boolean mAlwaysHideActionBar = false;

    private boolean mIsActionBarFocus = false;

    public boolean isActionBarHiddenForIntent() {
        return mAlwaysHideActionBar;
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (intent.hasExtra(HIDE_ACTION_BAR)) {
            boolean b = intent.getBooleanExtra(HIDE_ACTION_BAR, false);
            mAlwaysHideActionBar = b;
        }
        ...
        disableActionBarFocus();

        if (mAlwaysHideActionBar)
            getActionBar().hide();
    }
