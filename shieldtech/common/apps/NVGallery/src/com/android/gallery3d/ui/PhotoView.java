...
public class PhotoView extends GLView {
    ...
    private static final int MSG_JOY_SWITCH = 9;
    ...
    public void moveJoy(int i) {
        synchronized(this) {
           joyMoveDir = i;
        }
        if (mHandler.hasMessages(MSG_JOY_SWITCH)) return;

        mHandler.sendEmptyMessage(MSG_JOY_SWITCH);
    }
    private int joyMoveDir = 0;
    ...
    public boolean slideToNextPicture() {
    ...
    public boolean slideToPrevPicture() {
