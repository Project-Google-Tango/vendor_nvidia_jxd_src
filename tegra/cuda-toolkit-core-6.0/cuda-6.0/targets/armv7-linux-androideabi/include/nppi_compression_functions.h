 /* Copyright 2009-2013 NVIDIA Corporation.  All rights reserved. 
  * 
  * NOTICE TO LICENSEE: 
  * 
 ...
 */
 ...
 /**
 * Gather Huffman tokens of the JPEG Encoding for table optimization.
 * Input is expected to be 64x1 macro blocks and output is expected as a token histogram.
 *
 * \param pSrc \ref destination_image_pointer.
 * \param nSrcStep \ref destination_image_line_step.
 * \param nRestartInterval Restart Interval, see JPEG standard. Currently only values <=0 are supported.
 ...
 * \param nAh Bit Approximation High, see JPEG standard.
 * \param nAl Bit Approximation Low, see JPEG standard.
 * \param pTokenHistogramDC Histogram of Huffman DC tokens for further optimization.
 * \param pTokenHistogramAC Histogram of Huffman AC tokens for further optimization.
 * \param oSizeROI \ref roi_specification.
 * \return Error codes:
 *         - ::NPP_SIZE_ERROR For negative input height/width or not a multiple of
 *           8 width/height.
 ...
 */
 NppStatus
 nppiGatherHuffmanScan_JPEG_8u16s_P1R(const Npp16s * pSrc, Npp32s aSrcStep,
                                      Npp32s restartInterval, Npp32s Ss, Npp32s Se, Npp32s Ah, Npp32s Al,
                                      Npp32s* pTokenHistogramDC, 
                                      Npp32s* pTokenHistogramAC, 
 ...
 */
 NppStatus
 nppiGatherHuffmanScan_JPEG_8u16s_P3R(Npp16s * pSrc[3], Npp32s aSrcStep_[3],
                                      Npp32s restartInterval, Npp32s Ss, Npp32s Se, Npp32s Ah, Npp32s Al,
                                      Npp32s * pTokenHistogramDC[3], 
                                      Npp32s * pTokenHistogramAC[3], 
                                      NppiSize oSizeROI[3],
                                      Npp8u * pTempStorage);                    

 /**
 * Generate optimized Huffman table
 *
 * \param pTokenHistogram huffman token array
 * \param pCodeds number of Huffman codes in each length
 * \param pTable Huffman codes
 * \param nSs Start Coefficient, see JPEG standard.
 * \param nSe End Coefficient, see JPEG standard.
 * \param nAh Bit Approximation High, see JPEG standard.
 * \param nAl Bit Approximation Low, see JPEG standard.
 ...
 */
 NppStatus
 nppiOptimizeHuffman_JPEG(Npp32s* pTokenHistogram, Npp8u pCodes[16], Npp8u pTable[256],
                          Npp32s Ss, Npp32s Se, Npp32s Ah, Npp32s Al);
