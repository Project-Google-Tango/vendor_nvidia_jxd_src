 ...
 */
#define NVBOOT_BCT_MAX_SDRAM_SETS      2
 ...
 */
#define NVBOOT_BCT_CUSTOMER_DATA_WORDS 180
 ...
 */
#define NVBOOT_BCT_RESERVED_SIZE       7
 ...
 */
#define NVBOOT_BL_IRAM_START  (0x40000000 + 0xE000)
