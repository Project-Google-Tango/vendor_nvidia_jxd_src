 ...
 */
//For more details refer to https://p4viewer.nvidia.com/get/hw/doc/engr/Dev_ID/DeviceID_master_list.txt
 ...
 *
 * Major Revision 0x14:
 *   Rev 1: First tapeout for T148.
 */
#define CONST_NVBOOT_BOOTROM_VERSION (NVBOOT_VERSION(0x14, 0x01))
 ...
 *   Rev 1: First tapeout for T148.
 */
#define CONST_NVBOOT_RCM_VERSION (NVBOOT_VERSION(0x14, 0x01))
 ...
 *   Rev 1: First tapeout for T148.
 */
#define CONST_NVBOOT_BOOTDATA_VERSION (NVBOOT_VERSION(0x14, 0x01))
