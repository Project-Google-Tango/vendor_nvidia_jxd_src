 ...
 */
#define CONST_NVBOOT_BOOTROM_VERSION (NVBOOT_VERSION(0x35, 0x01))
 ...
 *   Rev 1: First tapeout for T35.
 */
#define CONST_NVBOOT_RCM_VERSION (NVBOOT_VERSION(0x35, 0x01))
 ...
 *   Rev 1: First tapeout for T35.
 */
#define CONST_NVBOOT_BOOTDATA_VERSION (NVBOOT_VERSION(0x35, 0x01))
