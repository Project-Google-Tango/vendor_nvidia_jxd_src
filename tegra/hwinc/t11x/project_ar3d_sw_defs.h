#if !defined(PROJECT_t35_ar3d_sw_defs_H)
#define PROJECT_t35_ar3d_sw_defs_H
...
//
//
// project_ap35_ar3d_sw_defs.h - ap15 project ar3d sw exported defines
//
// This file should only contain #define lines and comments
  // SLI
  #define NV_GR3D_HAS_DUAL_GR3D                0
  ...
  #define NV_GR3D_VPE_NUM_CONST_VECS           280
  ...
  // OES_shadow support
  #define NV_GR3D_HAS_SHADOW                   1

  // EXT_texture_sRGB and ARB_framebuffer_sRGB support
  #define NV_GR3D_HAS_SRGB                     1

  // ARB_texture_border_clamp support
  #define NV_GR3D_HAS_TEXTURE_BORDER_CLAMP     1

  // support for non-3D textures <= 8k-1 per dimension
  #define NV_GR3D_HAS_4K_TEXTURES              1
  ...
  #define NV_GR3D_SAMPLE_RES_LOG2              (NV_GR3D_SNAP_LOG2 - 1) // msaa sample need only 3 bits or fractional precision
  ...
  #define NV_GR3D_NUM_TEXSAMP_ENTRIES         (2 * NV_GR3D_NUM_TEXTURES)
  ...
  #define NV_GR3D_PSEQ_MAX_OUT_RECIRC_DEFAULT          495
  #define NV_GR3D_PSEQ_MIN_OUT_RECIRC_DEFAULT          448
  ...
  #define NV_GR3D_JUMP_TABLE_INST_NUM_WORDS         1
  #define NV_GR3D_NUM_PIXPKT_JUMP_TABLE_INST        (NV_GR3D_JUMP_TABLE_INST_NUM_WORDS * NV_GR3D_NUM_PIXPKT_INST)
  #define NV_GR3D_NUM_PIXPKT_JUMP_TABLE_INST_LOG2   log2(NV_GR3D_NUM_PIXPKT_JUMP_TABLE_INST)
  ...
  // number of core ALUs per pixel pipe
  #define NV_GR3D_NUM_ALU_CORES                3
  #define NV_GR3D_NUM_ALU_CORES_FPGA           2
  // number of alus (number of mads per core ALU)
  ...
  // maximum remap count for alu remap
  #define NV_GR3D_MAX_ALU_REMAP_COUNT          7
  // maximum number of instructions in the alu
  #define NV_GR3D_NUM_ALU_INST                 (2 * NV_GR3D_NUM_PIXPKT_INST)
  #define NV_GR3D_NUM_ALU_INST_LOG2            log2(NV_GR3D_NUM_ALU_INST)
  ...
  // these defines are in terms of words rather than full instructions
  #define NV_GR3D_ALU_INST_NUM_WORDS           2
  #define NV_GR3D_NUM_PIXPKT_ALU_INST          (NV_GR3D_ALU_INST_NUM_WORDS * NV_GR3D_NUM_ALUS * NV_GR3D_NUM_ALU_INST)
  ...
  #define NV_GR3D_TEX_MAX_SIZE_LOG2                     12
  ...
  // Z is basically S2.24
  #define NV_GR3D_Z_SIGN_BITS   1
  #define NV_GR3D_Z_INT_BITS    2
  #define NV_GR3D_Z_PREC_BITS   24
  #define NV_GR3D_Z_BITS (NV_GR3D_Z_SIGN_BITS + NV_GR3D_Z_INT_BITS + NV_GR3D_Z_PREC_BITS)
