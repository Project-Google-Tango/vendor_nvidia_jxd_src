...
#include "t30/nvboot_badblocks.h"
#include "t30/nvboot_devparams.h"
...
typedef struct NvBootLoaderInfoRec
{
    ...
    /// Specifies the signature of the BL.
...
{
    /// Specifies the signature for the rest of the BCT structure.
    NvBootHash          CryptoHash;
