...
typedef struct NvBootSdramParamsRec
{
    ...
    NvU32 EmcXm2DqsPadCtrl5;
    /// Specifies the value for EMC_XM2DQSPADCTRL6
    NvU32 EmcXm2DqsPadCtrl6;
    ...
    NvU32 McEmemAdrCfgBankSwizzle3;
