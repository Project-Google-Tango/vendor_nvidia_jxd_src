...
#include "sensor_bayer_imx135_camera_config.h"
#include "nvodm_tags.h"
#include "nv_log.h"
#include "camera_trace.h"

#define IMX135_HDR_ENABLE NV_TRUE
...
#define SENSOR_BAYER_PLL_MULT_DEFAULT            (0x01C2)
#define SENSOR_BAYER_PLL_MULT_2104X1560          (0x0110)
#define SENSOR_BAYER_PLL_PRE_DIV_DEFAULT         (0x000C)
#define SENSOR_BAYER_PLL_POS_DIV_DEFAULT         (0x0005)
#define SENSOR_BAYER_PLL_MULT_1920X1080          (0x00C9)
#define SENSOR_BAYER_PLL_MULT_640X480            (0x0159)

#define SENSOR_BAYER_PLL_MULT_SPECIAL            (0x01C2)
#define SENSOR_BAYER_PLL_PRE_DIV_SPECIAL         (0x000C)
...
#define SENSOR_BAYER_DEFAULT_MAX_COARSE_DIFF     4
...
#define DIFF_INTEGRATION_TIME_OF_MODE (0x01C5)

#define SENSOR_BAYER_EFFECTIVE_PIXEL_LENGTH      4224
#define SENSOR_BAYER_EFFECTIVE_LINE_HEIGHT       3136
#define SENSOR_BAYER_ACTIVE_X0                   8
#define SENSOR_BAYER_ACTIVE_Y0                   8
#define SENSOR_BAYER_ACTIVE_X1                   4215
#define SENSOR_BAYER_ACTIVE_Y1                   3127
#define SENSOR_BAYER_PHYSICAL_X                  4.713f //mm
#define SENSOR_BAYER_PHYSICAL_Y                  3.494f //mm

#define SENSOR_BAYER_DEFAULT_LINE_LENGTH_4096X3072       (0x11DC)
#define SENSOR_BAYER_DEFAULT_FRAME_LENGTH_4096X3072     (0x0c46)
#define SENSOR_BAYER_DEFAULT_EXPOSURE_COARSE_4096X3072  (SENSOR_BAYER_DEFAULT_FRAME_LENGTH_4096X3072-SENSOR_BAYER_DEFAULT_MAX_COARSE_DIFF)
#define SENSOR_BAYER_DEFAULT_MIN_FRAME_LENGTH_4096X3072  SENSOR_BAYER_DEFAULT_FRAME_LENGTH_4096X3072

#define SENSOR_BAYER_DEFAULT_LINE_LENGTH_1920X1080       (0x11DC)
...
#define SENSOR_BAYER_DEFAULT_LINE_LENGTH_1280X720       (0x11DC)
#define SENSOR_BAYER_DEFAULT_FRAME_LENGTH_1280X720     (0x0A40)
#define SENSOR_BAYER_DEFAULT_EXPOSURE_COARSE_1280X720  (SENSOR_BAYER_DEFAULT_FRAME_LENGTH_1280X720-SENSOR_BAYER_DEFAULT_MAX_COARSE_DIFF)
#define SENSOR_BAYER_DEFAULT_MIN_FRAME_LENGTH_1280X720  SENSOR_BAYER_DEFAULT_FRAME_LENGTH_1280X720

#define SENSOR_BAYER_DEFAULT_LINE_LENGTH_2616X1472       (0x11DC)
#define SENSOR_BAYER_DEFAULT_FRAME_LENGTH_2616X1472     (0x0A40)
#define SENSOR_BAYER_DEFAULT_EXPOSURE_COARSE_2616X1472  (SENSOR_BAYER_DEFAULT_FRAME_LENGTH_2616X1472-SENSOR_BAYER_DEFAULT_MAX_COARSE_DIFF)
#define SENSOR_BAYER_DEFAULT_MIN_FRAME_LENGTH_2616X1472  SENSOR_BAYER_DEFAULT_FRAME_LENGTH_2616X1472

#define SENSOR_BAYER_DEFAULT_LINE_LENGTH_3896X2192       (0x11DC)
#define SENSOR_BAYER_DEFAULT_FRAME_LENGTH_3896X2192     (0x0A40)
#define SENSOR_BAYER_DEFAULT_EXPOSURE_COARSE_3896X2192  (SENSOR_BAYER_DEFAULT_FRAME_LENGTH_3896X2192-SENSOR_BAYER_DEFAULT_MAX_COARSE_DIFF)
#define SENSOR_BAYER_DEFAULT_MIN_FRAME_LENGTH_3896X2192  SENSOR_BAYER_DEFAULT_FRAME_LENGTH_3896X2192

#define SENSOR_BAYER_DEFAULT_LINE_LENGTH_3840X2160 (0x11DC)
#define SENSOR_BAYER_DEFAULT_FRAME_LENGTH_3840X2160 (0x0A40)
#define SENSOR_BAYER_DEFAULT_EXPOSURE_COARSE_3840X2160 (SENSOR_BAYER_DEFAULT_FRAME_LENGTH_3840X2160-SENSOR_BAYER_DEFAULT_MAX_COARSE_DIFF)
#define SENSOR_BAYER_DEFAULT_MIN_FRAME_LENGTH_3840X2160 SENSOR_BAYER_DEFAULT_FRAME_LENGTH_3840X2160

#define SENSOR_BAYER_DEFAULT_LINE_LENGTH_2104X1560       (0x11DC)
#define SENSOR_BAYER_DEFAULT_FRAME_LENGTH_2104X1560      (0x0630)
#define SENSOR_BAYER_DEFAULT_EXPOSURE_COARSE_2104X1560   (SENSOR_BAYER_DEFAULT_FRAME_LENGTH_2104X1560-SENSOR_BAYER_DEFAULT_MAX_COARSE_DIFF)
#define SENSOR_BAYER_DEFAULT_MIN_FRAME_LENGTH_2104X1560  SENSOR_BAYER_DEFAULT_FRAME_LENGTH_2104X1560

#define SENSOR_BAYER_DEFAULT_LINE_LENGTH_640X480       (0x11DC)
#define SENSOR_BAYER_DEFAULT_FRAME_LENGTH_640X480      (0x01F6)
...
{
    "IMX135",  // string identifier, used for debugging
    ...
    {{24000, 226.f/24.f}}, // preferred clock profile
    {
    ...
    FOCUSER_NVC_GUID, // only set if focuser device is available
...
typedef struct SensorBayerIMX135ModeDependentSettingsRec
{
    NvU32 LineLength;
    NvU32 FrameLength;
    NvU32 CoarseTime;
    ...
    NvU32 PllPreDiv;
    NvU32 PllPosDiv;
} SensorBayerIMX135ModeDependentSettings;

static SensorBayerIMX135ModeDependentSettings ModeDependentSettings_4096x3072 =
{
    SENSOR_BAYER_DEFAULT_LINE_LENGTH_4096X3072,
    SENSOR_BAYER_DEFAULT_FRAME_LENGTH_4096X3072,
    SENSOR_BAYER_DEFAULT_EXPOSURE_COARSE_4096X3072,
    SENSOR_BAYER_DEFAULT_MIN_FRAME_LENGTH_4096X3072,
    1.0f,
...
static SensorBayerIMX135ModeDependentSettings ModeDependentSettings_1920x1080 =
{
    ...
    1.0f,
    SENSOR_BAYER_PLL_MULT_1920X1080,
    SENSOR_BAYER_PLL_PRE_DIV_DEFAULT,
    SENSOR_BAYER_PLL_POS_DIV_DEFAULT,
};

static SensorBayerIMX135ModeDependentSettings ModeDependentSettings_1280x720 =
{
    SENSOR_BAYER_DEFAULT_LINE_LENGTH_1280X720,
    SENSOR_BAYER_DEFAULT_FRAME_LENGTH_1280X720,
    SENSOR_BAYER_DEFAULT_EXPOSURE_COARSE_1280X720,
    SENSOR_BAYER_DEFAULT_MIN_FRAME_LENGTH_1280X720,
    1.0f,
...
static SensorBayerIMX135ModeDependentSettings ModeDependentSettings_2616x1472 =
{
    SENSOR_BAYER_DEFAULT_LINE_LENGTH_2616X1472,
    SENSOR_BAYER_DEFAULT_FRAME_LENGTH_2616X1472,
    SENSOR_BAYER_DEFAULT_EXPOSURE_COARSE_2616X1472,
    SENSOR_BAYER_DEFAULT_MIN_FRAME_LENGTH_2616X1472,
    1.0f,
    SENSOR_BAYER_PLL_MULT_SPECIAL,
    SENSOR_BAYER_PLL_PRE_DIV_SPECIAL,
    SENSOR_BAYER_PLL_POS_DIV_SPECIAL,
...
static SensorBayerIMX135ModeDependentSettings ModeDependentSettings_3896x2192 =
{
    SENSOR_BAYER_DEFAULT_LINE_LENGTH_3896X2192,
    SENSOR_BAYER_DEFAULT_FRAME_LENGTH_3896X2192,
    SENSOR_BAYER_DEFAULT_EXPOSURE_COARSE_3896X2192,
    SENSOR_BAYER_DEFAULT_MIN_FRAME_LENGTH_3896X2192,
    1.0f,
    SENSOR_BAYER_PLL_MULT_SPECIAL,
    SENSOR_BAYER_PLL_PRE_DIV_SPECIAL,
    SENSOR_BAYER_PLL_POS_DIV_SPECIAL,
...
static SensorBayerIMX135ModeDependentSettings ModeDependentSettings_3840x2160 =
{
SENSOR_BAYER_DEFAULT_LINE_LENGTH_3840X2160,
SENSOR_BAYER_DEFAULT_FRAME_LENGTH_3840X2160,
SENSOR_BAYER_DEFAULT_EXPOSURE_COARSE_3840X2160,
SENSOR_BAYER_DEFAULT_MIN_FRAME_LENGTH_3840X2160,
1.0f,
SENSOR_BAYER_PLL_MULT_SPECIAL,
SENSOR_BAYER_PLL_PRE_DIV_SPECIAL,
SENSOR_BAYER_PLL_POS_DIV_SPECIAL,
...
static SensorBayerIMX135ModeDependentSettings ModeDependentSettings_2104x1560 =
{
    SENSOR_BAYER_DEFAULT_LINE_LENGTH_2104X1560,
    SENSOR_BAYER_DEFAULT_FRAME_LENGTH_2104X1560,
    SENSOR_BAYER_DEFAULT_EXPOSURE_COARSE_2104X1560,
    SENSOR_BAYER_DEFAULT_MIN_FRAME_LENGTH_2104X1560,
    1.0f,
    SENSOR_BAYER_PLL_MULT_2104X1560,
    SENSOR_BAYER_PLL_PRE_DIV_SPECIAL,
    SENSOR_BAYER_PLL_POS_DIV_SPECIAL,
};

static SensorBayerIMX135ModeDependentSettings ModeDependentSettings_640x480 =
{
...
{
    {{{4208, 3120},  {0, 0}, 24, 1.0, 20, NvOdmImagerNoCropMode, {{0, 0, 0, 0}, {0.f, 0.f}}, NvOdmImagerModeType_Normal, SENSOR_BAYER_DEFAULT_LINE_LENGTH_4096X3072}, NULL, &ModeDependentSettings_4096x3072},
    {{{1920, 1080},  {0, 0}, 30, 1.0, 6, NvOdmImagerPartialCropMode, {{0, 0, 0, 0}, {0.f, 0.f}}, NvOdmImagerModeType_Normal, SENSOR_BAYER_DEFAULT_LINE_LENGTH_1920X1080}, NULL, &ModeDependentSettings_1920x1080},
    {{{1280, 720},  {0, 0}, 30, 1.0, 20, NvOdmImagerPartialCropMode, {{0, 0, 0, 0}, {0.f, 0.f}}, NvOdmImagerModeType_Normal, SENSOR_BAYER_DEFAULT_LINE_LENGTH_1280X720}, NULL, &ModeDependentSettings_1280x720},
    {{{1280, 720},  {0, 0}, 90, 1.0, 20, NvOdmImagerPartialCropMode, {{0, 0, 0, 0}, {0.f, 0.f}}, NvOdmImagerModeType_Normal, SENSOR_BAYER_DEFAULT_LINE_LENGTH_1280X720}, NULL, &ModeDependentSettings_1280x720},
    {{{2616, 1472},  {0, 0}, 30, 1.0, 20, NvOdmImagerPartialCropMode, {{0, 0, 0, 0}, {0.f, 0.f}}, NvOdmImagerModeType_Normal, SENSOR_BAYER_DEFAULT_LINE_LENGTH_2616X1472}, NULL, &ModeDependentSettings_2616x1472},//HDR
    {{{3896, 2192},  {0, 0}, 30, 1.0, 20, NvOdmImagerPartialCropMode, {{0, 0, 0, 0}, {0.f, 0.f}}, NvOdmImagerModeType_Normal, SENSOR_BAYER_DEFAULT_LINE_LENGTH_3896X2192}, NULL, &ModeDependentSettings_3896x2192},//HDR
    {{{3840, 2160},  {0, 0}, 30, 1.0, 20, NvOdmImagerPartialCropMode, {{0, 0, 0, 0}, {0.f, 0.f}}, NvOdmImagerModeType_Normal, SENSOR_BAYER_DEFAULT_LINE_LENGTH_3840X2160}, NULL, &ModeDependentSettings_3840x2160},
    {{{2104, 1560},  {0, 0}, 30, 1.0, 6, NvOdmImagerNoCropMode, {{0, 0, 0, 0}, {0.f, 0.f}}, NvOdmImagerModeType_Normal, SENSOR_BAYER_DEFAULT_LINE_LENGTH_2104X1560}, NULL, &ModeDependentSettings_2104x1560},//HDR
    {{{640, 480},  {0, 0}, 120, 1.0, 6, NvOdmImagerPartialCropMode, {{0, 0, 0, 0}, {0.f, 0.f}}, NvOdmImagerModeType_Normal, SENSOR_BAYER_DEFAULT_LINE_LENGTH_640X480}, NULL, &ModeDependentSettings_640x480},
};
...
static void
SensorIMX135_UpdateLinesPerSecond(
    ...
    NvU32 *pCoarseTime)
{
    ...
    if (NewFrameLength != pContext->FrameLength)
    {
        ...
        {
            int ret;
            ret = ioctl(pContext->camera_fd, IMX135_IOCTL_SET_FRAME_LENGTH,
                        NewFrameLength);
            if (ret < 0)
        ...
        SensorIMX135_UpdateLinesPerSecond(pContext);
    }
    else
    {
#if DEBUG_PRINTS
    ...
    if (pContext->CoarseTime != NewCoarseTime || pContext->HDREnabled)
    {
        ...
        if (!pCoarseTime || pContext->HDREnabled)
        {
            ...
            if (pContext->HDREnabled == NV_TRUE)
            {
                ...
                ret = ioctl(pContext->camera_fd, IMX135_IOCTL_SET_HDR_COARSE_TIME,
                            &values);
            }
            else
            {
                NewCoarseTimeShort = NewCoarseTime;
                ret = ioctl(pContext->camera_fd, IMX135_IOCTL_SET_COARSE_TIME,
                            NewCoarseTime);
            }
            if (ret < 0)
    ...
    NvU16 *pGain)
{
    ...
    {
        NvOsDebugPrintf("Err:imx135 odm:%s:gain %f is out of range (%f, %f)\n",
...
#if (BUILD_FOR_AOS == 0)
        int ret;
        ret = ioctl(pContext->camera_fd, IMX135_IOCTL_SET_GAIN, NewGains);
        if (ret < 0)
    ...
    NvOdmImagerSensorAE *sensorAE)
{
    ...
    NvOdmOsMemset(&ae, 0, sizeof(struct imx135_ae));

    if (sensorAE->HDRRatio_enable == NV_TRUE)
    {
        /* WAR to fix wrong HDR ratio and make sure ratio is always 1.0
         * delete 1.0 and uncomment when core is fixed */
        pContext->HDRRatio = 1.0; // sensorAE->HDRRatio;
    ...
    if (ae.gain_enable==NV_TRUE || ae.coarse_time_enable==NV_TRUE ||
            ae.frame_length_enable==NV_TRUE) {
        ret = ioctl(pContext->camera_fd, IMX135_IOCTL_SET_GROUP_HOLD, &ae);
        if (ret < 0)
        {
...
{
#if (BUILD_FOR_AOS == 0)
    struct imx135_flash_control fc;
    int ret;
    ...
    ret = ioctl(pContext->camera_fd, IMX135_IOCTL_SET_FLASH_MODE, &fc);
    if (ret < 0)
    {
...
static NvBool SensorBayer_Open(NvOdmImagerHandle hImager)
{
...
#if (BUILD_FOR_AOS == 0)
    pSensorBayerContext->camera_fd = open("/dev/imx135", O_RDWR);
    if (pSensorBayerContext->camera_fd < 0)
    {
        NvOsDebugPrintf("IMX135 ****  Can not open camera device: %s\n",
            strerror(errno));
        goto fail;
    }
    else
    ...
    ret = ioctl(pSensorBayerContext->camera_fd, IMX135_IOCTL_GET_FLASH_CAP, 0);
    if (ret < 0)
    {
    ...
    pSensorBayerContext->Exposure = -1.0; // invalid exposure
     ...
     // no need to convert gain's min/max to float for IMX135, because they are defined as float already.
    ...
    pSensorBayerContext->HDREnabled = IMX135_HDR_ENABLE;
    ...
    SetModeParameters *pResult)
{
    ...
    SensorBayerContext *pContext =
        (SensorBayerContext*)hImager->pSensor->pPrivateContext;
    NvU32 Index;
    SensorBayerIMX135ModeDependentSettings *pModeSettings;
    ...
    if ((pParameters->Exposure != 0.0) && (pContext->TestPatternMode != NV_TRUE))
    {
        ...
        if (!Status)
        {
            NvOsDebugPrintf("SensorIMX135_WriteExposure failed\n");
        }
    }
    else
    {
        ...
        pParameters->Gains[2] != 0.0 && pParameters->Gains[3] != 0.0)
    {
        ...
        if (!Status)
        {
            NvOsDebugPrintf("SensorIMX135_WriteGains failed\n");
        }
    }
    ...
    ret = ioctl(pContext->camera_fd, IMX135_IOCTL_SET_MODE, &mode);
    if (ret < 0) {
    ...
    NvOdmImagerPowerLevel PowerLevel)
{
    ...
    switch(PowerLevel)
    {
        case NvOdmImagerPowerLevel_On:
            ret = ioctl(pContext->camera_fd, IMX135_IOCTL_SET_POWER, 1);
            if (ret < 0) {
        ...
        case NvOdmImagerPowerLevel_Off:
            ret = ioctl(pContext->camera_fd, IMX135_IOCTL_SET_POWER, 0);
            if (ret < 0) {
    ...
    const void *pValue)
{
    ...
    switch(Param)
    {
        ...
        case NvOdmImagerParameter_FrameRateScheme:
        {
            ...
            NV_DEBUG_PRINTF(("Set NvOdmImagerParameter_FrameRateScheme to %d\n", pContext->FrameRateScheme));
        }
        break;
        ...
        default:
            NV_DEBUG_PRINTF(("[IMX135]:SetParameter(): %d not supported\n", Param));
            break;
        }
        return Status;
}
    ...
    void *pValue)
{
    ...
    switch(Param)
    {
...
#if (BUILD_FOR_AOS == 0)
                    ret = ioctl(pContext->camera_fd, IMX135_IOCTL_GET_STATUS, &status);
                    if (ret < 0)
        ...
        case NvOdmImagerParameter_FuseID:
#if (BUILD_FOR_AOS == 0)
            CHECK_PARAM_SIZE_RETURN_MISMATCH(SizeOfValue, sizeof(struct imx135_sensordata));
            ...
            ret = ioctl(pContext->camera_fd, IMX135_IOCTL_GET_SENSORDATA, &sensor_data);
            if (ret < 0)
            {
                NvOsDebugPrintf("IMX135: ioctl to get sensor data failed %s\n", strerror(errno));
                Status = NV_FALSE;
            }
            else
            {
                ...
                NvOdmOsMemcpy(pValue, &sensor_data, sizeof(struct imx135_sensordata));
                Status = NV_TRUE;
            }
        ...
        case NvOdmImagerParameter_SensorFrameRateLimitsAtResolution:
...

            {
                ...
                SensorBayerIMX135ModeDependentSettings *pModeSettings = NULL;
                ...
                MatchFound =
                    SensorIMX135_ChooseModeIndex(pContext, pData->Resolution,
                    &Index);
                ...
                pModeSettings = (SensorBayerIMX135ModeDependentSettings*)
                    g_pSensorBayerSetModeSequenceList[Index].pModeDependentSettings;
        ...
        // Phase 3.
        default:
            NV_DEBUG_PRINTF(("[IMX135]:GetParameter(): %d not supported\n", Param));
            Status = NV_FALSE;
            break;
    }
 ...
 */
NvBool SensorBayerIMX135_GetHal(NvOdmImagerHandle hImager)
{
    NV_DEBUG_PRINTF(("%s\n", __func__));
    if (!hImager || !hImager->pSensor)
        return NV_FALSE;
