...
const XAInterfaceID XA_IID_AUDIOENCODER = (XAInterfaceID) &SL_IID_array[MPH_AUDIOENCODER];
const XAInterfaceID XA_IID_AUDIOENCODERCAPABILITIES =
        (XAInterfaceID) &SL_IID_array[MPH_AUDIOENCODERCAPABILITIES];
...
const XAInterfaceID XA_IID_NVCAMERAEXTCAPABILITIES =
        (XAInterfaceID) &SL_IID_array[MPH_NVCAMERAEXTCAPABILITIES];
const XAInterfaceID XA_IID_NVVIDEOENCODEREXTCAPABILITIES =
        (XAInterfaceID) &SL_IID_array[MPH_NVVIDEOENCODEREXTCAPABILITIES];
const XAInterfaceID XA_IID_NVVIDEODECODEREXTCAPABILITIES =
        (XAInterfaceID) &SL_IID_array[MPH_NVVIDEODECODEREXTCAPABILITIES];
const XAInterfaceID XA_IID_NVVIDEODECODER =
        (XAInterfaceID) &SL_IID_array[MPH_NVVIDEODECODER];
const XAInterfaceID XA_IID_NVVIDEOENCODEREXT =
        (XAInterfaceID) &SL_IID_array[MPH_NVVIDEOENCODEREXT];
const XAInterfaceID XA_IID_GETCAPABILITIESOFINTERFACE =
        (XAInterfaceID) &SL_IID_array[MPH_GETCAPABILITIESOFINTERFACE];
const XAInterfaceID XA_IID_NVPUSHAPP =
        (XAInterfaceID)&SL_IID_array[MPH_NVPUSHAPP];
const XAInterfaceID XA_IID_NVBURSTMODE=
        (XAInterfaceID)&SL_IID_array[MPH_NVBURSTMODE];
#ifdef __cplusplus
}
#endif
