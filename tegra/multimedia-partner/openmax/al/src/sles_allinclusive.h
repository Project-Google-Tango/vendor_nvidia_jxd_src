...
#include <errno.h>
#include "NVOMXAL_VideoExtensions.h"
#include "NVOMXAL_CameraExtensions.h"
#include "NVOMXAL_RecorderExtensions.h"
#include "NVOMXAL_CapabilitiesExtensions.h"
#include "NVOMXAL_DataTapExtensions.h"
...
extern IObject *construct(const ClassTable *clazz,
    unsigned exposedMask, SLEngineItf engine, SLuint32 numInterfaces,
...
extern SLresult CCameraDevice_Realize(void *self, SLboolean async);
extern SLresult CCameraDevice_Resume(void *self, SLboolean async);
extern void CCameraDevice_Destroy(void *self);
extern predestroy_t CCameraDevice_PreDestroy(void *self);

extern SLresult CMediaRecorder_Realize(void *self, SLboolean async);
extern SLresult CMediaRecorder_Resume(void *self, SLboolean async);
extern void CMediaRecorder_Destroy(void *self);
extern predestroy_t CMediaRecorder_PreDestroy(void *self);

extern SLresult CNvDataTap_Realize(void *self, SLboolean async);
extern SLresult CNvDataTap_Resume(void *self, SLboolean async);
extern void CNvDataTap_Destroy(void *self);
extern predestroy_t CNvDataTap_PreDestroy(void *self);
