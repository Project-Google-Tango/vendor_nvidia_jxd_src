...
#endif
#ifdef LINUX_OMXAL
    {MPH_XAAUDIODECODERCAPABILITIES, INTERFACE_EXPLICIT,
        offsetof(CEngine, mAudioDecoderCapabilities)},
    {MPH_XAAUDIOENCODERCAPABILITIES, INTERFACE_EXPLICIT,
        offsetof(CEngine, mAudioEncoderCapabilities)},
    {MPH_XAAUDIOIODEVICECAPABILITIES, INTERFACE_IMPLICIT,
        offsetof(CEngine, mAudioIODeviceCapabilities)},
    {MPH_XACONFIGEXTENSION, INTERFACE_OPTIONAL,
        offsetof(CEngine, mConfigExtensions)},
    {MPH_XADEVICEVOLUME, INTERFACE_OPTIONAL,
        offsetof(CEngine, mDeviceVolume)},
    {MPH_XADYNAMICINTERFACEMANAGEMENT, INTERFACE_IMPLICIT,
        offsetof(CEngine, mDynamicInterfaceManagement)},
    {MPH_XATHREADSYNC, INTERFACE_IMPLICIT, offsetof(CEngine, mThreadSync)},
#endif
    {MPH_XAVIDEODECODERCAPABILITIES, INTERFACE_EXPLICIT,
        offsetof(CEngine, mVideoDecoderCapabilities)},
    {MPH_XACAMERACAPABILITIES, INTERFACE_EXPLICIT,
        offsetof(CEngine, mCameraCapabilities)},
    {MPH_XAIMAGEDECODERCAPABILITIES, INTERFACE_EXPLICIT,
        offsetof(CEngine, mImageDecoderCapabilities)},
    {MPH_XAIMAGEENCODERCAPABILITIES, INTERFACE_EXPLICIT,
        offsetof(CEngine, mImageEncoderCapabilities)},
    {MPH_XAVIDEOENCODERCAPABILITIES, INTERFACE_EXPLICIT,
        offsetof(CEngine, mVideoEncoderCapabilities)},
    {MPH_NVCAMERAEXTCAPABILITIES, INTERFACE_EXPLICIT,
        offsetof(CEngine, mNvCameraExtCapabilities)},
    {MPH_NVVIDEOENCODEREXTCAPABILITIES, INTERFACE_EXPLICIT,
        offsetof(CEngine, mNvVideoEncoderExtCapabilities)},
    {MPH_NVVIDEODECODEREXTCAPABILITIES, INTERFACE_EXPLICIT,
        offsetof(CEngine, mNvVideoDecoderExtCapabilities)},
    {MPH_GETCAPABILITIESOFINTERFACE, INTERFACE_EXPLICIT,
        offsetof(CEngine, mGetCapabilitiesOfInterface)}
};
...
#endif
#ifdef LINUX_OMXAL
    {MPH_XACONFIGEXTENSION, INTERFACE_OPTIONAL, offsetof(COutputMix, mConfigExtensions)},
    {MPH_XADYNAMICINTERFACEMANAGEMENT, INTERFACE_IMPLICIT,
        offsetof(COutputMix, mDynamicInterfaceManagement)},
    {MPH_XAEQUALIZER, INTERFACE_EXPLICIT, offsetof(COutputMix, mEqualizer)},
    {MPH_XAOUTPUTMIX, INTERFACE_IMPLICIT, offsetof(COutputMix, mOutputMix)},
    {MPH_XAVOLUME, INTERFACE_EXPLICIT, offsetof(COutputMix, mVolume)},
#endif
};
...
static const struct iid_vtable MediaPlayer_interfaces[INTERFACES_MediaPlayer] = {
    ...
    {MPH_NVVIDEODECODER, INTERFACE_EXPLICIT, offsetof(CMediaPlayer, mNvVideoDecoder)},
    {MPH_XAVIDEOPOSTPROCESSING, INTERFACE_EXPLICIT, offsetof(CMediaPlayer, mVideoPostProcessing)},
#endif
#ifdef LINUX_OMXAL
    {MPH_NVVIDEODECODER, INTERFACE_EXPLICIT, offsetof(CMediaPlayer, mNvVideoDecoder)},
    {MPH_XAVIDEOPOSTPROCESSING, INTERFACE_EXPLICIT, offsetof(CMediaPlayer, mVideoPostProcessing)},
    {MPH_XACONFIGEXTENSION, INTERFACE_OPTIONAL, offsetof(CMediaPlayer, mConfigExtensions)},
    {MPH_XADYNAMICSOURCE, INTERFACE_OPTIONAL, offsetof(CMediaPlayer, mDynamicSource)},
    {MPH_XAEQUALIZER, INTERFACE_OPTIONAL, offsetof(CMediaPlayer, mEqualizer)},
    {MPH_XAIMAGECONTROLS, INTERFACE_OPTIONAL, offsetof(CMediaPlayer, mImageControls)},
    {MPH_XAIMAGEEFFECTS, INTERFACE_OPTIONAL, offsetof(CMediaPlayer, mImageEffects)},
    {MPH_XAMETADATAEXTRACTION, INTERFACE_EXPLICIT, offsetof(CMediaPlayer, mMetadataExtraction)},
    {MPH_XAMETADATATRAVERSAL, INTERFACE_EXPLICIT, offsetof(CMediaPlayer, mMetadataTraversal)},
    {MPH_XAPLAYBACKRATE, INTERFACE_EXPLICIT, offsetof(CMediaPlayer, mPlaybackRate)},
#endif
};
...
static const struct iid_vtable CameraDevice_interfaces[INTERFACES_CameraDevice] = {
    {MPH_XAOBJECT, INTERFACE_IMPLICIT_PREREALIZE, offsetof(CCameraDevice, mObject)},
    {MPH_XACAMERA, INTERFACE_IMPLICIT, offsetof(CCameraDevice, mCameraDevice)},
    {MPH_XADYNAMICINTERFACEMANAGEMENT, INTERFACE_IMPLICIT,
        offsetof(CCameraDevice, mDynamicInterfaceManagement)},
    {MPH_XACONFIGEXTENSION, INTERFACE_EXPLICIT, offsetof(CCameraDevice, mConfigExtensions)},
    {MPH_XAIMAGECONTROLS, INTERFACE_EXPLICIT, offsetof(CCameraDevice, mImageControls)},
    {MPH_XAIMAGEEFFECTS, INTERFACE_DYNAMIC, offsetof(CCameraDevice, mImageEffects)},
    {MPH_XAVIDEOPOSTPROCESSING, INTERFACE_EXPLICIT, offsetof(CCameraDevice, mVideoPostProcessing)},
};

static const ClassTable CCameraDevice_class = {
    CameraDevice_interfaces,
    INTERFACES_CameraDevice,
    MPH_to_CameraDevice,
    "CameraDevice",
    sizeof(CCameraDevice),
    0,      // OpenSL ES object ID
    XA_OBJECTID_CAMERADEVICE,
    CCameraDevice_Realize,
    CCameraDevice_Resume,
    CCameraDevice_Destroy,
    CCameraDevice_PreDestroy
};

//MEDIARECORDER class

static const struct iid_vtable MediaRecorder_interfaces[INTERFACES_MediaRecorder] = {
    {MPH_XAOBJECT, INTERFACE_IMPLICIT_PREREALIZE, offsetof(CMediaRecorder, mObject)},
    {MPH_XARECORD, INTERFACE_EXPLICIT, offsetof(CMediaRecorder, mRecord)},
    {MPH_AUDIOENCODER, INTERFACE_EXPLICIT, offsetof(CMediaRecorder, mAudioEncoder)},
    {MPH_XAAUDIOENCODERCAPABILITIES, INTERFACE_EXPLICIT,
        offsetof(CMediaRecorder, mAudioEncoderCapabilities)},
    {MPH_XAVIDEOENCODER, INTERFACE_EXPLICIT, offsetof(CMediaRecorder, mVideoEncoder)},
    {MPH_XASNAPSHOT, INTERFACE_EXPLICIT, offsetof(CMediaRecorder, mSnapshot)},
    {MPH_XAIMAGEENCODER, INTERFACE_EXPLICIT, offsetof(CMediaRecorder, mImageEncoder)},
    {MPH_XAMETADATAINSERTION, INTERFACE_DYNAMIC, offsetof(CMediaRecorder, mMetadataInsertion)},
    {MPH_XADYNAMICINTERFACEMANAGEMENT, INTERFACE_IMPLICIT,
        offsetof(CMediaRecorder, mDynamicInterfaceManagement)},

    {MPH_XACONFIGEXTENSION, INTERFACE_EXPLICIT, offsetof(CMediaRecorder, mConfigExtensions)},
    {MPH_XAEQUALIZER, INTERFACE_DYNAMIC, offsetof(CMediaRecorder, mEqualizer)},
    {MPH_XAIMAGECONTROLS, INTERFACE_EXPLICIT, offsetof(CMediaRecorder, mImageControls)},
    {MPH_XAIMAGEEFFECTS, INTERFACE_DYNAMIC, offsetof(CMediaRecorder, mImageEffects)},
    {MPH_XAMETADATAEXTRACTION, INTERFACE_EXPLICIT, offsetof(CMediaRecorder, mMetadataExtraction)},
    {MPH_XAMETADATATRAVERSAL, INTERFACE_EXPLICIT, offsetof(CMediaRecorder, mMetadataTraversal)},
    {MPH_XAVIDEOPOSTPROCESSING, INTERFACE_EXPLICIT, offsetof(CMediaRecorder, mVideoPostProcessing)},
    {MPH_XAVOLUME, INTERFACE_EXPLICIT, offsetof(CMediaRecorder, mVolume)},
    {MPH_NVVIDEOENCODEREXT, INTERFACE_EXPLICIT, offsetof(CMediaRecorder, mNvVideoEncoderExt)},
    {MPH_NVBURSTMODE, INTERFACE_EXPLICIT, offsetof(CMediaRecorder, mNvBurstMode)},
#ifdef ANDROID
    {MPH_ANDROIDBUFFERQUEUESOURCE, INTERFACE_EXPLICIT, offsetof(CMediaRecorder, mAndroidBufferQueue)},
#endif
};

static const ClassTable CMediaRecorder_class = {
    MediaRecorder_interfaces,
    INTERFACES_MediaRecorder,
    MPH_to_MediaRecorder,
    "MediaRecorder",
    sizeof(CMediaRecorder),
    0,      // OpenSL ES object ID
    XA_OBJECTID_MEDIARECORDER,
    CMediaRecorder_Realize,
    CMediaRecorder_Resume,
    CMediaRecorder_Destroy,
    CMediaRecorder_PreDestroy
};

//NVDATATAP class
static const struct iid_vtable NvDataTap_interfaces[INTERFACES_NvDataTap] = {
    {MPH_OBJECT, INTERFACE_IMPLICIT_PREREALIZE, offsetof(CNvDataTap, mObject)},
    {MPH_NVPUSHAPP, INTERFACE_IMPLICIT, offsetof(CNvDataTap, mNvPushApp)},
    {MPH_DYNAMICINTERFACEMANAGEMENT, INTERFACE_IMPLICIT, offsetof(CNvDataTap, mDynamicInterfaceManagement)},
    {MPH_XACONFIGEXTENSION, INTERFACE_EXPLICIT, offsetof(CNvDataTap, mConfigExtensions)}
};

static const ClassTable CNvDataTap_class = {
    NvDataTap_interfaces,
    INTERFACES_NvDataTap,
    MPH_to_NvDataTap,
    "NvDataTap",
    sizeof(CNvDataTap),
    0,      // OpenSL ES object ID
    NVXA_OBJECTID_DATATAP,
    CNvDataTap_Realize,
    CNvDataTap_Resume,
    CNvDataTap_Destroy,
    CNvDataTap_PreDestroy
};
