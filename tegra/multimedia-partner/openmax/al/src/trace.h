...
#define SL_ENTER_GLOBAL SLresult result = SL_RESULT_SUCCESS;
#define SL_LEAVE_GLOBAL return result;
#define SL_ENTER_INTERFACE SLresult result = SL_RESULT_SUCCESS;
#define SL_LEAVE_INTERFACE return result;
#define SL_ENTER_INTERFACE_VOID
#define SL_LEAVE_INTERFACE_VOID return;

#define XA_ENTER_GLOBAL XAresult result = XA_RESULT_SUCCESS;
#define XA_LEAVE_GLOBAL return result;
#define XA_ENTER_INTERFACE XAresult result = XA_RESULT_SUCCESS;
#define XA_LEAVE_INTERFACE return result;
#ifdef LINUX_OMXAL
#define XA_ENTER_INTERFACE_VOID
#define XA_LEAVE_INTERFACE_VOID return;
#endif
#else
...
#define SL_ENTER_GLOBAL SLresult result = SL_RESULT_SUCCESS; slTraceEnterGlobal(__FUNCTION__);
#define SL_LEAVE_GLOBAL slTraceLeaveGlobal(__FUNCTION__, result); return result;
#define SL_ENTER_INTERFACE SLresult result = SL_RESULT_SUCCESS; slTraceEnterInterface(__FUNCTION__);
...
#define XA_ENTER_GLOBAL XAresult result = XA_RESULT_SUCCESS; slTraceEnterGlobal(__FUNCTION__);
#define XA_LEAVE_GLOBAL slTraceLeaveGlobal(__FUNCTION__, result); return result;
#define XA_ENTER_INTERFACE XAresult result = XA_RESULT_SUCCESS; slTraceEnterInterface(__FUNCTION__);
#define XA_LEAVE_INTERFACE slTraceLeaveInterface(__FUNCTION__, result); return result;
#ifdef LINUX_OMXAL
#define XA_ENTER_INTERFACE_VOID slTraceEnterInterfaceVoid(__FUNCTION__);
#define XA_LEAVE_INTERFACE_VOID slTraceLeaveInterfaceVoid(__FUNCTION__); return;
#endif
#endif
