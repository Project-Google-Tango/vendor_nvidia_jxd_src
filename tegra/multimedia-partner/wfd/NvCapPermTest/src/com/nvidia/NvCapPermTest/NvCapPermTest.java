...
package com.nvidia.NvCapPermTest;
...
public class NvCapPermTest extends Service {
    ...
    /** Load JNI library */
    static {
        System.loadLibrary("nvcappermtest_jni");
    }

    /** Debug Tags */
    private static final String TAG = "NvCapPermTest";
    ...
    private void handleIntent(Intent intent) {
        ...
        String ctrlVal = intent.getStringExtra("com.nvidia.NvCapPermTest.NvCapControl");
        if (ctrlVal == null) {
