...
#ifndef INCLUDED_T11X_DATA_LAYOUT_H
#define INCLUDED_T11X_DATA_LAYOUT_H
...
void t11xUpdateBct(struct BuildBctContextRec *Context, UpdateEndState EndState);
void t11xUpdateBl(struct BuildBctContextRec *Context, UpdateEndState EndState);
