...
static FieldItem s_SdramFieldTable[] =
{
    ...
    DESC_U32_FIELD(EmcBctSpare1),
    DESC_U32_FIELD(EmcBctSpare2),
    DESC_U32_FIELD(EmcBctSpare3),
    DESC_U32_FIELD(EmcBctSpare4),
    DESC_U32_FIELD(EmcBctSpare5),
    DESC_U32_FIELD(EmcBctSpare6),
    DESC_U32_FIELD(EmcBctSpare7),
    DESC_U32_FIELD(EmcBctSpare8),
    DESC_U32_FIELD(EmcBctSpare9),
    DESC_U32_FIELD(EmcBctSpare10),
    DESC_U32_FIELD(EmcBctSpare11),
    ...
    DESC_U32_FIELD(EmcDllXformDqs8),
    DESC_U32_FIELD(EmcDllXformDqs9),
    DESC_U32_FIELD(EmcDllXformDqs10),
    DESC_U32_FIELD(EmcDllXformDqs11),
    DESC_U32_FIELD(EmcDllXformDqs12),
    DESC_U32_FIELD(EmcDllXformDqs13),
    DESC_U32_FIELD(EmcDllXformDqs14),
    DESC_U32_FIELD(EmcDllXformDqs15),
    ...
    DESC_U32_FIELD(EmcDllXformAddr3),
    DESC_U32_FIELD(EmcDllXformAddr4),
    DESC_U32_FIELD(EmcDllXformAddr5),
    DESC_U32_FIELD(EmcDllXformQUse8),
    DESC_U32_FIELD(EmcDllXformQUse9),
    DESC_U32_FIELD(EmcDllXformQUse10),
    DESC_U32_FIELD(EmcDllXformQUse11),
    DESC_U32_FIELD(EmcDllXformQUse12),
    DESC_U32_FIELD(EmcDllXformQUse13),
    DESC_U32_FIELD(EmcDllXformQUse14),
    DESC_U32_FIELD(EmcDllXformQUse15),
    ...
    DESC_U32_FIELD(EmcDliTrimTxDqs8),
    DESC_U32_FIELD(EmcDliTrimTxDqs9),
    DESC_U32_FIELD(EmcDliTrimTxDqs10),
    DESC_U32_FIELD(EmcDliTrimTxDqs11),
    DESC_U32_FIELD(EmcDliTrimTxDqs12),
    DESC_U32_FIELD(EmcDliTrimTxDqs13),
    DESC_U32_FIELD(EmcDliTrimTxDqs14),
    DESC_U32_FIELD(EmcDliTrimTxDqs15),
    DESC_U32_FIELD(EmcDllXformDq0),
    DESC_U32_FIELD(EmcDllXformDq1),
    DESC_U32_FIELD(EmcDllXformDq2),
    DESC_U32_FIELD(EmcDllXformDq3),
    DESC_U32_FIELD(EmcDllXformDq4),
    DESC_U32_FIELD(EmcDllXformDq5),
    DESC_U32_FIELD(EmcDllXformDq6),
    DESC_U32_FIELD(EmcDllXformDq7),
    ...
    DESC_U32_FIELD(McDisExtraSnapLevels),
    ...
    DESC_U32_FIELD(PmcVddpSelWait),
    DESC_U32_FIELD(PmcDdrPwr),
    DESC_U32_FIELD(PmcDdrCfg),
    DESC_U32_FIELD(PmcIoDpd3Req),
    DESC_U32_FIELD(PmcIoDpd3ReqWait),
    DESC_U32_FIELD(PmcRegShort),
    DESC_U32_FIELD(PmcNoIoPower),
    DESC_U32_FIELD(PmcPorDpdCtrlWait),
    ...
    DESC_U32_FIELD(EmcXm2CmdPadCtrl5),
    ...
    DESC_U32_FIELD(EmcXm2DqsPadCtrl5),
    DESC_U32_FIELD(EmcXm2DqsPadCtrl6),
    DESC_U32_FIELD(EmcXm2DqPadCtrl),
    DESC_U32_FIELD(EmcXm2DqPadCtrl2),
    DESC_U32_FIELD(EmcXm2DqPadCtrl3),
    ...
    DESC_U32_FIELD(EmcXm2VttGenPadCtrl3),
    ...
    DESC_U32_FIELD(McEmemAdrCfgBankSwizzle3),
    ...
    DESC_U32_FIELD(McEmemArbOverride1),
    DESC_U32_FIELD(McEmemArbRsv),
    DESC_U32_FIELD(McClkenOverride),
    DESC_U32_FIELD(McStatControl),
    DESC_U32_FIELD(McDisplaySnapRing),
    DESC_U32_FIELD(McVideoProtectBom),
    DESC_U32_FIELD(McVideoProtectBomAdrHi),
    DESC_U32_FIELD(McVideoProtectSizeMb),
    DESC_U32_FIELD(McVideoProtectVprOverride),
    DESC_U32_FIELD(McVideoProtectVprOverride1),
    DESC_U32_FIELD(McVideoProtectGpuOverride0),
    DESC_U32_FIELD(McVideoProtectGpuOverride1),
    DESC_U32_FIELD(McSecCarveoutBom),
    DESC_U32_FIELD(McSecCarveoutAdrHi),
    ...
    DESC_U32_FIELD(McMtsCarveoutBom),
    DESC_U32_FIELD(McMtsCarveoutAdrHi),
    DESC_U32_FIELD(McMtsCarveoutSizeMb),
    DESC_U32_FIELD(McMtsCarveoutRegCtrl),
...
static ParseSubfieldItem s_DeviceTypeTable[] =
{
    ...
    { "SnorParams.", Token_SnorParams, s_SnorTable, t12xSetSnorParam },

    { "SpiFlashParams.",
      Token_SpiFlashParams,
      s_SpiFlashTable,
      t12xSetSpiFlashParam },
...
ParseFieldName(char *Rest, FieldItem *FieldTable, FieldItem **Field)
{
    ...
    NvAuPrintf("\n Error: Wrong config file is being used."
                 " Config file have unexpected parameters %s \n", Rest);
...
ParseSdramParam(BuildBctContext *Context, ParseToken Token, char *Rest, char *Prefix)
{
    ...
    /* Store the result. */
    return t12xSetSdramParam(Context, Index, Field->Token, Value);
}
                            ...
                            char *Rest, char *Prefix)
{
    ...
    return t12xSetValue(Context, Token, Value);
}
...
void t12xProcessConfigFile(BuildBctContext *Context)
{
  ...
  if (((NvBootConfigTable *)(Context->NvBCT))->DevType[Index] == NvBootDevType_Snor)
    {
        for (i = 0; s_SnorTable[i].Token != 0; i++)
        {
            if (DeviceIndexZero == NV_TRUE && s_SnorTable[i].StatusZero == NV_FALSE)
            {
                NvAuPrintf("\n Error: Config file doesn't have parameters"
            ...
            if (DeviceIndexOne == NV_TRUE && s_SnorTable[i].StatusOne== NV_FALSE)
            {
                NvAuPrintf("\n Error: Config file doesn't have parameters"
            ...
            if (DeviceIndexTwo == NV_TRUE && s_SnorTable[i].StatusTwo== NV_FALSE)
            {
                NvAuPrintf("\n Error: Config file doesn't have parameters"
            ...
            if (DeviceIndexThree == NV_TRUE && s_SnorTable[i].StatusThree== NV_FALSE)
            {
                NvAuPrintf("\n Error: Config file doesn't have parameters"
              ...
              (DeviceIndexTwo != NV_TRUE) || (DeviceIndexThree != NV_TRUE))
        {
            if ((DeviceIndexZero != NV_TRUE) && (DeviceIndexThree == NV_TRUE))
            {
                ((NvBootConfigTable *)(Context->NvBCT))->DevParams[0].SnorParams =
                    ((NvBootConfigTable *)(Context->NvBCT))->DevParams[3].SnorParams;
                DeviceIndexZero = NV_TRUE;
            }
            if ((DeviceIndexZero == NV_TRUE) && (DeviceIndexOne != NV_TRUE))
            {
                ((NvBootConfigTable *)(Context->NvBCT))->DevParams[1].SnorParams =
                    ((NvBootConfigTable *)(Context->NvBCT))->DevParams[0].SnorParams;
                DeviceIndexOne = NV_TRUE;
            }
            if ((DeviceIndexOne == NV_TRUE) && (DeviceIndexTwo != NV_TRUE))
            {
                ((NvBootConfigTable *)(Context->NvBCT))->DevParams[2].SnorParams =
                    ((NvBootConfigTable *)(Context->NvBCT))->DevParams[1].SnorParams;
                DeviceIndexTwo = NV_TRUE;
            }
            if ((DeviceIndexTwo == NV_TRUE) && (DeviceIndexThree != NV_TRUE))
