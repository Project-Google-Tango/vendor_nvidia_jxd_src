...
#ifndef INCLUDED_T12X_DATA_LAYOUT_H
#define INCLUDED_T12X_DATA_LAYOUT_H
...
void t12xUpdateBct(struct BuildBctContextRec *Context, UpdateEndState EndState);
void t12xUpdateBl(struct BuildBctContextRec *Context, UpdateEndState EndState);
