    ...
    NvU32 *NumInstances)
{
    ...
    switch (DataType)
    {
        ...
        case NvBctDataType_SignedSection:
            *Size = (NvU32)(((NvU8 *)bct + sizeof(NvBootConfigTable))
...
static NvError NvBctPrivGetDataT14x(
    NvBctHandle hBct,
    NvBctDataType DataType,
    NvU32 *Size,
    NvU32 *Instance,
    void *Data)
{
    ...
    switch (DataType)
    {
        ...
        case NvBctDataType_SignedSection:
        {
            NvOsMemcpy(Data, &bct->RandomAesBlock, *Size);
        }
        break;
...
static NvError NvBctPrivSetDataT14x(
    NvBctHandle hBct,
    NvBctDataType DataType,
    NvU32 *Size,
    NvU32 *Instance,
    void *Data)
{
    ...
    switch (DataType)
    {
        ...
        case NvBctDataType_SignedSection:
        {
            NvOsMemcpy(&bct->RandomAesBlock, Data, *Size);
        }
        break;
...
NvU32
NvBctPrivGetSignatureOffsetT14x(void)
{
    NvU32 Offset = 0;
    NvBootConfigTable Bct;
...
NvU32
NvBctPrivGetSignDataOffsetT14x(void)
{
    NvU32 Offset = 0;
    NvBootConfigTable Bct;
