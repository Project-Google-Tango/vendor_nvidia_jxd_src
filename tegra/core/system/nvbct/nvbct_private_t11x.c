...
static NvError NvBctPrivGetDataT11x(
    NvBctHandle hBct,
    NvBctDataType DataType,
    NvU32 *Size,
    NvU32 *Instance,
...
static NvError NvBctPrivSetDataT11x(
    NvBctHandle hBct,
    NvBctDataType DataType,
    NvU32 *Size,
    NvU32 *Instance,
...
NvU32
NvBctPrivGetSignatureOffsetT11x(void)
{
    NvU32 Offset = 0;
    NvBootConfigTable Bct;
...
NvU32
NvBctPrivGetSignDataOffsetT11x(void)
{
    NvU32 Offset = 0;
    NvBootConfigTable Bct;
