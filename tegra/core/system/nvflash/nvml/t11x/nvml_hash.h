 ...
 * @file nvml_hash.h
 *
 * Internal NvMlHash interface for NvMl
 *
 * NvMlHash is NVIDIA's interface for computing the AES-CMAC keyed hash
 * function.
 *
...
#ifndef INCLUDED_NVML_HASH_H
#define INCLUDED_NVML_HASH_H
