...
typedef enum
{
    ...
    /// Specifies a LVDS display pin group.
    NvOdmGpioPinGroup_LvdsDisplay,
    ...
    /// Specifies a pin for wake-up from key-board, touch-pad, and  battery connected to EC.
    NvOdmGpioPinGroup_EmbeddedController,

    /// Specifies a group for battery.
    NvOdmGpioPinGroup_Battery,

    /// Specifies a group for Fuse.
    NvOdmGpioPinGroup_Fuse,

    /// Specifies a group for Panel ID strap.
    NvOdmGpioPinGroup_TouchPanelSwitch,

    /// Specifies a group for Joystick Controller.
    NvOdmGpioPinGroup_JoystickController,

    /// Specifies a group for Io Exapander
    NvOdmGpioPinGroup_IoExpander,
...
#define NvOdmGpioPin_DisplayPanel6Pincount   (4)
#define NvOdmGpioPin_DisplayPanel6Start      (NvOdmGpioPin_DisplayPanel5End + 1)

#define NvOdmGpioPin_DisplayPanel6End        (NvOdmGpioPin_DisplayPanel6Start + NvOdmGpioPin_DisplayPanel6Pincount - 1)

#define NvOdmGpioPin_DisplayPinCount         (NvOdmGpioPin_DisplayPanel6End + 1)
...
#define NvOdmGpioPin_BluetoothPower        (NvOdmGpioPin_BluetoothReset + 1)
