...
NVERROR(DispDsiReadAckError,                0x0002000C, "DSI display read ack error resport")
...
NVERROR(SdioEnablePowerRailFailed,          0x0004200b, "enable power rail failed")
...
NVERROR(XusbDeviceNotAttached,              0x00043501, "xusb not attached")
NVERROR(XusbPortResetFailed,                0x00043502, "xusb port reset failed")
NVERROR(XusbInvalidBmRequest,               0x00043503, "xusb invalid bm request")
NVERROR(XusbParseConfigDescFail,            0x00043504, "xusb parsing config descriptor failed")
NVERROR(XusbMscInvalidCmd,                  0x00043505, "xusb invalid msc command")
NVERROR(XusbCswStatusCmdFail,               0x00043506, "xusb csw status cmd failed")
NVERROR(XusbMscResetRecovery,               0x00043507, "xusb msc reset recovery")
NVERROR(XusbEpStalled,                      0x00043508, "xusb EP stalled")
NVERROR(XusbEpError,                        0x00043509, "xusb EP error")
NVERROR(XusbEpRetry,                        0x0004350A, "xusb EP retry")
NVERROR(XusbEpNotReady,                     0x0004350B, "xusb EP not ready")
NVERROR(XusbDeviceResponseError,             0x0004350C, "xusb Device response error")
...
NVERROR(I2cSlaveNotStarted,                 0x00045100, "I2c slave not started")
NVERROR(I2cSlaveAlreadyStarted,             0x00045101, "I2c slave is already started on this channel")
NVERROR(I2cSlaveTxBufferFull,               0x00045102, "I2c slave tx buffer full and no space for writing any new data")
NVERROR(I2cSlaveWriteProgress,              0x00045103, "I2c slave write (master read) is in progress")
NVERROR(I2cSlaveWriteNotStarted,            0x00045104, "I2c slave write has not been started yet")
...
NVERROR(UnderConfident,                     0x0007000C, "algorithm has insufficient confidence to return result")
...
NVERROR(CameraHwNotResponding,              0x00090007, "camera hw not responding")
...
NVERROR(VideoEncEnqReorderBuffer,           0x000E1001, "Current buffer needs to be enqueued for reordering")
NVERROR(VideoEncEmptyReorderBufferQ,        0x000E1002, "Encode all buffers present in reorder queue")
NVERROR(VideoEncSkipHwBuffEnQ,              0x000E1003, "Don't enqueue the buffer in HWBufferQueue")
...
NVERROR(VideoDecBypassMoreWork,                0x000E3801, "Decoder should bypass any more work related to current task")
...
NVERROR(ParserTruncatedFile,                0x00100012, "Indicates teh fiel is broken/truncated")
NVERROR(ParserOffsetsNotFound,              0x00100013, "Indicates teh fiel is broken/truncated")
...
NVERROR(WriterTimeLimitExceeded,     0x00101010, "Write time limit exceeded in writer")
...
NVERROR(RefURLAvailable,                    0x0010200D, "ReferenceURLAvailable")
...
/* Nor specific block driver errors */
NVERROR(NorBlockDriverEraseFailure,         0x00140301, "Nor Block Driver erase failed")
NVERROR(NorBlockDriverWriteFailure,         0x00140302, "Nor Block Driver write failed")
NVERROR(NorBlockDriverReadFailure,          0x00140303, "Nor Block Driver read failed")
NVERROR(NorBlockDriverLockFailure,          0x00140304, "Nor Block Driver lock failed")
NVERROR(NorRegionIllegalAddress,            0x00140305, "Nor Block Driver sector access illegal")
NVERROR(NorRegionTableOpFailure,            0x00140306, "Nor Block Driver region operation failed")
NVERROR(NorBlockDriverMultiInterleave,      0x00140307, "Nor Block Driver multiple interleave modes")
...
NVERROR(SysUpdateInvalidChecksum,           0x00170001, "NvSysUpdate Invalid Checksum")
NVERROR(SysUpdateBLUpdateNotAllowed,        0x00170002, "NvSysUpdate BL update not allowed")

/* Nor error codes */
NVERROR(NorReadFailed,                     0x00180000, "Nor Read failed")
NVERROR(NorProgramFailed,                  0x00180001, "Nor Program failed")
NVERROR(NorOperationFailed,                0x00180002, "requested Nor operation failed")
NVERROR(NorBusy,                           0x00180003, "Nor operation incomplete and is busy")
NVERROR(NorNotOpened,                      0x00180004, "Nor driver not opened")
NVERROR(NorAlreadyOpened,                  0x00180005, "Nor driver is already opened")
NVERROR(NorBadOperationRequest,            0x00180006, "status for wrong Nor operation is requested ")
NVERROR(NorCommandQueueError,              0x00180007, "Command queue error occured ")
NVERROR(NorReadEccFailed,                  0x00180008, "Read with ECC resulted in uncorrectable errors")
NVERROR(NorFlashNotSupported,              0x00180009, "Nor flash on board is not supported by the ddk")
NVERROR(NorLockFailed,                     0x00180010, "Nor flash lock feature failed")
NVERROR(NorWriteFailed,                    0x00180011, "Nor Write failed")
NVERROR(NorBadState,                       0x00180012, "Indicates an invalid state")
NVERROR(NorBlockIsLocked,                  0x00180013, "Indicates the block is locked")
NVERROR(NorEraseFailed,                    0x00180014, "Nor Erase failed")

/* NvBDKTest error codes */
NVERROR(BDKTestRegistrationCleanupFailed,  0x00190000, "Cleanup of default registration failed")
NVERROR(BDKTestCreateDefaultRegFailed   ,  0x00190001, "Create Default Registration failed")
NVERROR(BDKTestUnknownTest,                0x00190002, "An Unknown test is being run or registered.")
NVERROR(BDKTestUnknownSuite,               0x00190003, "An Unknown suite is being run or registered.")
NVERROR(BDKTestDupeTest,                   0x00190004, "Test already exists.Duplicate test being run or registered")
NVERROR(BDKTestDupeSuite,                  0x00190005, "Suite already exists.Duplicate test being run or registered")
NVERROR(BDKTestUnknownType,                0x00190006, "Request for a type of test which has not been registered")
NVERROR(BDKTestNoRegistration,             0x00190007, "Test Registry not initalized")
NVERROR(BDKTestNoSuite,                    0x00190008, "No test suites registered")
NVERROR(BDKTestNoTest,                     0x00190009, "No tests registered")
NVERROR(BDKTestNullTestFuncPtr,            0x00190010, "Test function pointer is null")

/* NvDiag error codes */
NVERROR(DiagDataComparisonMismatch,        0x00200000, "Data Comparison failure")

/*fuse error codes */
NVERROR(InvalidCombination,                0x00210000, "SBK & Device Key fuses cant be burned with security_mode fuse")
NVERROR(SecurityModeBurn,                  0x00210001, "security_mode fuse should be the last fuse to be burned")

/*se error codes */
NVERROR(RsaPssVerify_Inconsistent,         0x00310000, "Inconsistency in verification during RsaPss")
/** @} */
