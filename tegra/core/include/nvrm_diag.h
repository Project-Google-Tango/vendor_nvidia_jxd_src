...
typedef enum
{
    ...
    NvRmDiagModuleID_DTV,
    NvRmDiagModuleID_Tsensor,
    NvRmDiagModuleID_Atomics,
    ...
    /// Specifies Tegra secure coprocessor (TSEC)
        NvRmDiagModuleID_TSEC,

    /// Specifies XUSB
        NvRmDiagModuleID_XUSB_CORE_HOST,
    NvRmDiagModuleID_XUSB_FALCON,
    NvRmDiagModuleID_XUSB_FS,
    NvRmDiagModuleID_XUSB_SS,

    /// Specifies Mipibif
        NvRmDiagModuleID_Mipibif,

    /// Specifies Virtual GPIO
        NvRmDiagModuleID_Vgpio,
