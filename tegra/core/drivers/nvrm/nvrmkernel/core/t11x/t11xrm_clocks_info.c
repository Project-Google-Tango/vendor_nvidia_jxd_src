...
static const NvRmFixedClockInfo s_T11xFixedClockTable[] =
{
    {
        NvRmClockSource_ClkS,
...
static const NvU32 s_T11xFixedClockTableSize = NV_ARRAY_SIZE(s_T11xFixedClockTable);
 ...
 */
static const NvRmPllClockInfo s_T11xPllClockTable[] =
{
    {   /* PLLA base output */
...
static const NvU32 s_T11xPllClockTableSize = NV_ARRAY_SIZE(s_T11xPllClockTable);

/*****************************************************************************/

static const NvRmDividerClockInfo s_T11xDividerClockTable[] =
{
...
static const NvU32 s_T11xDividerClockTableSize = NV_ARRAY_SIZE(s_T11xDividerClockTable);

/*****************************************************************************/

static const NvRmCoreClockInfo s_T11xCoreClockTable[] =
{
    {
        NvRmClockSource_CpuBus,
        {
...
static const NvU32 s_T11xCoreClockTableSize = NV_ARRAY_SIZE(s_T11xCoreClockTable);

/*****************************************************************************/

static const NvRmSelectorClockInfo s_T11xSelectorClockTable[] =
{
    {0},
};

static const NvU32 s_T11xSelectorClockTableSize = NV_ARRAY_SIZE(s_T11xSelectorClockTable);

/*****************************************************************************/
/*****************************************************************************/

static NvRmClockSourceInfo s_T11xClockSourceTable[NvRmClockSource_Num] = {{0}};
...
do\
{\
    Src.p##type = (NvRm##type##ClockInfo*)s_T11x##type##ClockTable;\
    NvRmPrivParseClockSources( \
        s_T11xClockSourceTable, NvRmClockSource_Num, \
        Src, s_T11x##type##ClockTableSize, NvRmClockSourceType_##type); \
} while(0)

        NvOsMemset(s_T11xClockSourceTable, 0, sizeof(s_T11xClockSourceTable));
...
#undef PARSE_SOURCE_TABLE
        ...
        return &s_T11xClockSourceTable[0];
}

/*****************************************************************************/

static NvBool s_T11xPllM0Clocks[NV_ARRAY_SIZE(g_ModuleClockTable)] = {0};
static NvBool s_T11xPllC0Clocks[NV_ARRAY_SIZE(g_ModuleClockTable)] = {0};
static NvBool s_T11xPllP0Clocks[NV_ARRAY_SIZE(g_ModuleClockTable)] = {0};
static NvBool s_T11xPllA0Clocks[NV_ARRAY_SIZE(g_ModuleClockTable)] = {0};
static NvBool s_T11xPllD0Clocks[NV_ARRAY_SIZE(g_ModuleClockTable)] = {0};
static NvBool s_T11xPllX0Clocks[NV_ARRAY_SIZE(g_ModuleClockTable)] = {0};

static NvRmPllReference s_T11xPllReferencesTable[] =
{
    { NvRmClockSource_PllM0, NvRmDfsStatusFlags_StopPllM0, 0, s_T11xPllM0Clocks, 0 },
    { NvRmClockSource_PllC0, NvRmDfsStatusFlags_StopPllC0, 0, s_T11xPllC0Clocks, 0 },
    { NvRmClockSource_PllP0, NvRmDfsStatusFlags_StopPllP0, 0, s_T11xPllP0Clocks, 0 },
    { NvRmClockSource_PllA0, NvRmDfsStatusFlags_StopPllA0, 0, s_T11xPllA0Clocks, 0 },
    { NvRmClockSource_PllD0, NvRmDfsStatusFlags_StopPllD0, 0, s_T11xPllD0Clocks, 0 },
    { NvRmClockSource_PllX0, NvRmDfsStatusFlags_StopPllX0, 0, s_T11xPllX0Clocks, 0 },
};
static const NvU32 s_T11xPllReferencesTableSize =
    NV_ARRAY_SIZE(s_T11xPllReferencesTable);
...
{
    NvU32 i;
    for (i = 0; i < s_T11xPllReferencesTableSize; i++)
    {
        NvOsMemset(s_T11xPllReferencesTable[i].AttachedModules, 0,
                   sizeof(NvBool) * g_ModuleClockTableSize);
        s_T11xPllReferencesTable[i].ReferenceCnt = 0;
        s_T11xPllReferencesTable[i].ExternalClockRefCnt = 0;
    }
    *pPllReferencesTable = s_T11xPllReferencesTable;
    *pPllReferencesTableSize = s_T11xPllReferencesTableSize;
}

/*****************************************************************************/

// Power Gating Ids for each Power Group specified in re-location table header
static const NvU32 s_T11xPowerGroupIds[] = { NV_POWERGROUP_ENUM_TABLE };
...
{
    *pPowerGroupIdsTable = s_T11xPowerGroupIds;
    *pPowerGroupIdsTableSize = NV_ARRAY_SIZE(s_T11xPowerGroupIds);
}
