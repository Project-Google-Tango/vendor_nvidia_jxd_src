...
const NvU16 g_T11xGpioPadMapping[] =
{
    //  Port A
    ...
    //  Port B
    GPIO_TRISTATE(GMI_A17), GPIO_TRISTATE(GMI_A18), GPIO_RESERVED(), GPIO_RESERVED(),
    ...
    GPIO_TRISTATE(GEN1_I2C_SCL), GPIO_TRISTATE(GEN1_I2C_SDA), GPIO_RESERVED(), GPIO_TRISTATE(GMI_WP_N),
    //Port D
    ...
    //  Port I
    GPIO_TRISTATE(GMI_WR_N), GPIO_TRISTATE(GMI_OE_N), GPIO_RESERVED(), GPIO_TRISTATE(GMI_CS6_N),
    GPIO_TRISTATE(GMI_RST_N),GPIO_TRISTATE(GMI_IORDY), GPIO_TRISTATE(GMI_CS7_N), GPIO_TRISTATE(GMI_WAIT),
    //  Port J
    GPIO_TRISTATE(GMI_CS0_N), GPIO_RESERVED(),  GPIO_TRISTATE(GMI_CS1_N), GPIO_TRISTATE(GMI_DQS_P),
    GPIO_RESERVED(), GPIO_TRISTATE(UART2_CTS_N), GPIO_TRISTATE(UART2_RTS_N), GPIO_TRISTATE(GMI_A16),
    //  Port K
    ...
    GPIO_TRISTATE(SYS_CLK_REQ), GPIO_TRISTATE(PWR_I2C_SCL), GPIO_TRISTATE(PWR_I2C_SDA),
    //  Port AA
    ...
    GPIO_RESERVED(), GPIO_RESERVED(), GPIO_RESERVED(), GPIO_RESERVED(),
    //  Port EE
    GPIO_TRISTATE(CLK3_OUT), GPIO_TRISTATE(CLK3_REQ), GPIO_TRISTATE(CLK1_REQ), GPIO_TRISTATE(HDMI_CEC)
                           ...
                           NvU32 *pMapping)
{
    ...
    if ((Pin >= GpiosPerPort) || (Index >= NV_ARRAY_SIZE(g_T11xGpioPadMapping)))
        return NV_FALSE;

    *pMapping = (NvU32)g_T11xGpioPadMapping[Index];
