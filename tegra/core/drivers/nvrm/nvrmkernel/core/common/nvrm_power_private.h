...
// FIXME: Temporary definitions for bring up
#define NVRM_POWER_BRINGUP_RETURN(hRm, cond) \
...
/**
 * Sets Max applicable CPU voltage and clock.
 *
...
/**
 * Sets given cpu clock.
 *
 * @param hRmDevice The RM device handle.
 */
#if NVODM_CPU_BOOT_PERF_SET
void
NvRmPrivSetCpuClock(NvRmDeviceHandle hRmDevice, NvRmFreqKHz freq);
#endif
