...
#define NVRM_T30_SOC_INITIAL_DFS_STATE (NvRmDfsRunState_Disabled)
...
static NvError SystatMonitorsGetCapabilities(NvRmDfs* pDfs)
{
    ...
    NvRmDfsModule* pCaps;
    static NvRmDfsModule SystatCaps[1] = {{{0}}};
    NvRmModuleCapability ModuleCaps[] =
        {
            {1, 0, 0, NvRmModulePlatform_Silicon, (void*)SystatCaps},
        };
    NvRmModuleTable *tbl;
    ...
    error = NvRmModuleGetCapabilities(hRm, ModuleId, ModuleCaps,
                NV_ARRAY_SIZE(ModuleCaps), (void **)&pCaps);
    if (error != NvSuccess)
    {
...
static NvError VdeMonitorsGetCapabilities(NvRmDfs* pDfs)
{
    ...
    NvRmModuleID ModuleId;
    NvRmDfsModule* pCaps;
    static NvRmDfsModule VdeCaps[2] = {{{0}}};
    NvRmModuleCapability ModuleCaps[] =
        {
            {1, 0, 0, NvRmModulePlatform_Silicon, (void*)&VdeCaps[0]},
            {1, 1, 0, NvRmModulePlatform_Silicon, (void*)&VdeCaps[0]},
            {1, 2, 0, NvRmModulePlatform_Silicon, (void*)&VdeCaps[1]},
        };
    NvRmModuleTable *tbl;
...
static NvError EmcMonitorsGetCapabilities(NvRmDfs* pDfs)
{
    ...
    NvRmModuleID ModuleId;
    NvRmDfsModule* pCaps;
    static NvRmDfsModule EmcCaps[3] = {{{0}}};
    NvRmModuleCapability ModuleCaps[] =
        {
            {1, 0, 0, NvRmModulePlatform_Silicon, (void*)&EmcCaps[1]},
            {1, 1, 0, NvRmModulePlatform_Silicon, (void*)&EmcCaps[1]},
            {1, 2, 0, NvRmModulePlatform_Silicon, (void*)&EmcCaps[2]},
        };
    NvRmModuleTable *tbl;
    NvRmDeviceHandle hRm = pDfs->hRm;
    ...
    EmcCaps[1].DomainMap[NvRmDfsClockId_Emc] = NV_FALSE;
...
NvError NvRmPrivDfsInit(NvRmDeviceHandle hRmDeviceHandle)
{
    ...
    {
        case ExecPlatform_Soc:
            switch (pDfs->hRm->ChipId.Id)
            {
            case 0x30:
                pDfs->DfsRunState = NVRM_T30_SOC_INITIAL_DFS_STATE;
                break;
            }
            break;
        case ExecPlatform_Fpga:
...
void NvRmPrivDvsInit(void)
{
    ...
    if (NvRmPrivIsCpuRailDedicated(pDfs->hRm))
    {
        ...
        pDvs->DvsCorner.CpuMv = pDvs->CurrentCpuMv;
#else
