...
#include "nvddk_fuse_read_priv_t14x.h"
...
static NvDdkFuseBootDevice StrapDevSelMap[] =
{
    ...
    NvDdkFuseBootDevice_Sdmmc,         // NvStrapDevSel_Emmc_Boot_on
    NvDdkFuseBootDevice_Sdmmc,         // NvStrapDevSel_Emmc_Boot_off
};
...
static NvU32 NvDdkFuseGetStrapDevSelectMapT14x(NvU32 RegData)
{
    return StrapDevSelMap[RegData];
}

static void NvDdkFuseGetUniqueIdT14x(NvU64 *pUniqueId)
{
...
static NvU32 NvDdkFuseGetFuseToDdkDevMapT14x(NvU32 RegData)
{
...
static NvU32 NvDdkFuseGetSecBootDevInstanceT14x(NvU32 BootDev,
                                                NvU32 BootDevConfig)
{
...
static NvStrapDevSel NvStrapDeviceSelectionT14x(void)
{
    NvU32 RegData;
    NvU8 *pMisc;
    NvError e;
...
static NvU32 NvDdkFuseGetSecBootDeviceRawT14x(void)
{
    NvU32 RegData;
    NvStrapDevSel StrapDevSel;
    StrapDevSel = NvStrapDeviceSelectionT14x();
    ...
    if (!NvDdkFuseSkipDevSelStraps() && StrapDevSel != NvStrapDevSel_UseFuses)
    {
        ...
        RegData     = NvDdkFuseGetStrapDevSelectMapT14x(StrapDevSel);
    }
    else
    {
...
static NvU32 NvDdkFuseGetSecBootDeviceT14x(void)
{
    NvU32 RegData;

    RegData = NvDdkFuseGetSecBootDeviceRawT14x();
    return NvDdkFuseGetFuseToDdkDevMapT14x(RegData);
}
...
static void NvDdkFuseGetOpModeT14x(NvDdkFuseOperatingMode *pMode)
{
...
static NvError NvDdkFuseGetPublicKeyHashT14x(NvU8 *pKey)
{
...
static NvBool NvDdkFuseIsWatchdogEnabledT14x(void)
{
    NvU32 RegData;
...
static NvBool NvDdkFuseIsUsbChargerDetectionEnabledT14x(void)
{
    NvU32 RegData;
    ...
    NvU32 *Size)
{
    ...
    switch (Type)
    {
        ...
        case NvDdkFuseDataType_SecBootDeviceSelect:
            RegData = NvDdkFuseGetSecBootDeviceT14x();
            if ((NvS32)RegData < 0)
        ...
        case NvDdkFuseDataType_Uid:
            ...
            NvDdkFuseGetUniqueIdT14x((NvU64*)pData);
            SetFuseRegVisibility(0);
            break;

        case NvDdkFuseDataType_OpMode:
            NvDdkFuseGetOpModeT14x((NvDdkFuseOperatingMode *)pData);
            break;

        case NvDdkFuseDataType_SecBootDevInst:
            BootDev = NvDdkFuseGetSecBootDeviceT14x();
            if ((NvS32)BootDev < 0)
                return NvError_InvalidState;
            Config = NvDdkFuseGetBootDevInfo();
            RegData = NvDdkFuseGetSecBootDevInstanceT14x(BootDev, Config);
            if ((NvS32)RegData < 0)
                return NvError_InvalidState;
            *((NvU32 *)pData) = RegData;
            break;
        ...
        case NvDdkFuseDataType_PublicKeyHash:
            return NvDdkFuseGetPublicKeyHashT14x((NvU8*)pData);
            break;

        case NvDdkFuseDataType_WatchdogEnabled:
            *((NvBool*)pData) = NvDdkFuseIsWatchdogEnabledT14x();
            break;

        case NvDdkFuseDataType_UsbChargerDetectionEnabled:
            *((NvBool*)pData) = NvDdkFuseIsUsbChargerDetectionEnabledT14x();
            break;
        ...
        case NvDdkFuseDataType_CpuSpeedo0:
            *((NvU32 *)pData) = FUSE_NV_READ32(FUSE_CPU_SPEEDO_0_CALIB_0);
            break;

        case NvDdkFuseDataType_CpuSpeedo1:
            *((NvU32 *)pData) = FUSE_NV_READ32(FUSE_CPU_SPEEDO_1_CALIB_0);
            break;

        case NvDdkFuseDataType_CpuSpeedo2:
            *((NvU32 *)pData) = FUSE_NV_READ32(FUSE_CPU_SPEEDO_2_CALIB_0);
            break;

        case NvDdkFuseDataType_CpuIddq:
            *((NvU32 *)pData) = FUSE_NV_READ32(FUSE_CPU_IDDQ_CALIB_0);
            break;

        case NvDdkFuseDataType_SocSpeedo0:
            *((NvU32 *)pData) = FUSE_NV_READ32(FUSE_SOC_SPEEDO_0_CALIB_0);
            break;

        case NvDdkFuseDataType_SocSpeedo1:
            *((NvU32 *)pData) = FUSE_NV_READ32(FUSE_SOC_SPEEDO_1_CALIB_0);
            break;

        case NvDdkFuseDataType_SocSpeedo2:
            *((NvU32 *)pData) = FUSE_NV_READ32(FUSE_SOC_SPEEDO_2_CALIB_0);
            break;

        case NvDdkFuseDataType_SocIddq:
            *((NvU32 *)pData) = FUSE_NV_READ32(FUSE_SOC_IDDQ_CALIB_0);
            break;

        case NvDdkFuseDataType_OdmInfo:
            *((NvU32 *)pData) = FUSE_NV_READ32(FUSE_ODM_INFO_0);
            break;
