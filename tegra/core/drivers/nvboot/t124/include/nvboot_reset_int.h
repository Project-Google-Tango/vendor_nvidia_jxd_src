...
typedef enum
{
    ...
    // FIXME - Figure out which SPI controller for BOOT ROM
    NvBootResetDeviceId_SpiId    = CLK_RST_CONTROLLER_RST_DEVICES_U_0_SWR_SPI4_RST_SHIFT   + NVBOOT_RESET_U_REG,
    ...
    NvBootResetDeviceId_Spi5Id	 = CLK_RST_CONTROLLER_RST_DEVICES_V_0_SWR_SPI5_RST_SHIFT + NVBOOT_RESET_V_REG,
    NvBootResetDeviceId_Spi6Id	 = CLK_RST_CONTROLLER_RST_DEVICES_V_0_SWR_SPI6_RST_SHIFT + NVBOOT_RESET_V_REG,
