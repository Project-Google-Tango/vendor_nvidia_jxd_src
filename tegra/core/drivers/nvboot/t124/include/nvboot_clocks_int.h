...
typedef enum
{
    ...
    NvBootClocksClockId_SpiId    = CLK_RST_CONTROLLER_CLK_OUT_ENB_U_0_CLK_ENB_SPI4_SHIFT
                                 + NVBOOT_CLOCKS_STANDARD_ENB + NVBOOT_CLOCKS_U_REG
                                 + (CLK_RST_CONTROLLER_CLK_SOURCE_SPI4_0 << NVBOOT_CLOCKS_SOURCE_SHIFT),
    ...
    NvBootClocksClockId_Sbc5Id	 = CLK_RST_CONTROLLER_CLK_OUT_ENB_V_0_CLK_ENB_SPI5_SHIFT
                            + NVBOOT_CLOCKS_STANDARD_ENB + NVBOOT_CLOCKS_V_REG
                            + (CLK_RST_CONTROLLER_CLK_SOURCE_SPI5_0 << NVBOOT_CLOCKS_SOURCE_SHIFT),

    NvBootClocksClockId_Sbc6Id	 = CLK_RST_CONTROLLER_CLK_OUT_ENB_V_0_CLK_ENB_SPI6_SHIFT
                             + NVBOOT_CLOCKS_STANDARD_ENB + NVBOOT_CLOCKS_V_REG
                             + (CLK_RST_CONTROLLER_CLK_SOURCE_SPI6_0 << NVBOOT_CLOCKS_SOURCE_SHIFT),
