...
NvU32
NvBootHostT1xxRcmGetMsgBufferLength(
    NvU32 PayloadLength)
{
    ...
    NvU8 **pMsgBuffer)
{
    ...
    NvBootHostT1xxRcmInitMsg(MsgBuffer, MsgBufferLength, OpCode, RandomAesBlock,
    ...
    e = NvBootHostT1xxRcmSignMsg(MsgBuffer, OpMode, Sbk);
    if ( e != NvSuccess )
        goto done;
    ...
    NvU8 **pMsgBuffer)
{
    ...
    PayloadBuffer = NvBootHostT1xxRcmGetMsgPayloadBuffer(MsgBuffer);
    ...
    NvU8 **pMsgBuffer)
{
    ...
    *pMsgBuffer = (NvU8 *)NULL;
    ...
    e = NvBootHostT1xxRcmCreateMsgFromFileHandle(OpCode, RandomAesBlock, Args,
