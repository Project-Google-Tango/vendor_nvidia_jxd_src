...
#include "t14x/nvboot_clocks.h"
#include "t14x/nvboot_error.h"
#include "t14x/nvboot_osc.h"
...
#define NVBOOT_CLOCKS_X_REG (0xC0)    // TODO: Check
#define NVBOOT_CLOCKS_V_REG (0x100)
#define NVBOOT_CLOCKS_Y_REG (0x200)
...
#define NVBOOT_CLOCKS_HAS_YREG_ENB(ClockId)    (((NvU32) ClockId) & NVBOOT_CLOCKS_Y_REG)
...
typedef enum
{
    ...
    NvBootClocksClockId_SpiId    = CLK_RST_CONTROLLER_CLK_OUT_ENB_H_0_CLK_ENB_SPI3_SHIFT
                                 + NVBOOT_CLOCKS_STANDARD_ENB + NVBOOT_CLOCKS_H_REG
    ...
    NvBootClocksClockId_I2c6Id = CLK_RST_CONTROLLER_CLK_OUT_ENB_X_0_CLK_ENB_I2C6_SHIFT
                                 + NVBOOT_CLOCKS_STANDARD_ENB + NVBOOT_CLOCKS_X_REG
                                 + (CLK_RST_CONTROLLER_CLK_SOURCE_I2C6_0 << NVBOOT_CLOCKS_SOURCE_SHIFT),


    NvBootClocksClockId_Spi1Id	 = CLK_RST_CONTROLLER_CLK_OUT_ENB_H_0_CLK_ENB_SPI1_SHIFT
                                + NVBOOT_CLOCKS_STANDARD_ENB + NVBOOT_CLOCKS_H_REG
                                + (CLK_RST_CONTROLLER_CLK_SOURCE_SPI1_0 << NVBOOT_CLOCKS_SOURCE_SHIFT),

    NvBootClocksClockId_Spi2Id	 = CLK_RST_CONTROLLER_CLK_OUT_ENB_H_0_CLK_ENB_SPI2_SHIFT
                           + NVBOOT_CLOCKS_STANDARD_ENB + NVBOOT_CLOCKS_H_REG
                           + (CLK_RST_CONTROLLER_CLK_SOURCE_SPI2_0 << NVBOOT_CLOCKS_SOURCE_SHIFT),

    NvBootClocksClockId_Spi3Id	 = CLK_RST_CONTROLLER_CLK_OUT_ENB_H_0_CLK_ENB_SPI3_SHIFT
                            + NVBOOT_CLOCKS_STANDARD_ENB + NVBOOT_CLOCKS_H_REG
                            + (CLK_RST_CONTROLLER_CLK_SOURCE_SPI3_0 << NVBOOT_CLOCKS_SOURCE_SHIFT),

    NvBootClocksClockId_McCpuId = CLK_RST_CONTROLLER_CLK_OUT_ENB_X_0_CLK_ENB_MC_CPU_SHIFT
                                 + NVBOOT_CLOCKS_STANDARD_ENB + NVBOOT_CLOCKS_Y_REG,

    NvBootClocksClockId_McCbpaId = CLK_RST_CONTROLLER_CLK_OUT_ENB_X_0_CLK_ENB_MC_CBPA_SHIFT
                                 + NVBOOT_CLOCKS_STANDARD_ENB + NVBOOT_CLOCKS_Y_REG,

    NvBootClocksClockId_McCapaId = CLK_RST_CONTROLLER_CLK_OUT_ENB_X_0_CLK_ENB_MC_CAPA_SHIFT
                                 + NVBOOT_CLOCKS_STANDARD_ENB + NVBOOT_CLOCKS_Y_REG,

    NvBootClocksClockId_VgpioId = CLK_RST_CONTROLLER_CLK_OUT_ENB_X_0_CLK_ENB_VGPIO_SHIFT
                                 + NVBOOT_CLOCKS_STANDARD_ENB + NVBOOT_CLOCKS_Y_REG,

    NvBootClocksClockId_GpioId  = CLK_RST_CONTROLLER_CLK_OUT_ENB_L_0_CLK_ENB_GPIO_SHIFT
                                 + NVBOOT_CLOCKS_STANDARD_ENB,

    NvBootClocksClockId_AvpucqId   = CLK_RST_CONTROLLER_CLK_OUT_ENB_U_0_CLK_ENB_AVPUCQ_SHIFT
                                 + NVBOOT_CLOCKS_STANDARD_ENB + NVBOOT_CLOCKS_U_REG
                                 + (CLK_RST_CONTROLLER_CLK_OUT_ENB_U_0 << NVBOOT_CLOCKS_SOURCE_SHIFT),

    NvBootClocksClockId_Force32 = 0x7fffffff,

    NvBootClocksClockId_Spi5Id	 = NvBootClocksClockId_Force32,

    NvBootClocksClockId_Spi6Id	 = NvBootClocksClockId_Force32,

    NvBootClocksClockId_SnorId = NvBootClocksClockId_Force32,

    NvBootClocksClockId_NandId   = NvBootClocksClockId_Force32,

    NvBootClocksClockId_NandSpeedId   = NvBootClocksClockId_Force32,

    NvBootClocksClockId_XUsbId   = NvBootClocksClockId_Force32,

    NvBootClocksClockId_XUsbHostId   = NvBootClocksClockId_Force32,

    NvBootClocksClockId_Usb3Id   = NvBootClocksClockId_Force32,

    NvBootClocksClockId_Emc1Id    = NvBootClocksClockId_Force32,

    NvBootClocksClockId_Mc1Id    = NvBootClocksClockId_Force32
...
#define NVBOOT_CLOCKS_CHECK_CLOCKID(ClockId) \
    NV_ASSERT( (ClockId == NvBootClocksClockId_SclkId) || \
               ...
               (ClockId == NvBootClocksClockId_I2c6Id) || \
               (ClockId == NvBootClocksClockId_Spi1Id) || \
               (ClockId == NvBootClocksClockId_Spi2Id) || \
               (ClockId == NvBootClocksClockId_Spi3Id) || \
               (ClockId == NvBootClocksClockId_McCpuId) || \
               (ClockId == NvBootClocksClockId_McCapaId) || \
               (ClockId == NvBootClocksClockId_McCbpaId) || \
               (ClockId == NvBootClocksClockId_VgpioId) || \
               (ClockId == NvBootClocksClockId_GpioId) || \
               (ClockId == NvBootClocksClockId_AvpucqId) || \
               0);
 ...
 */
// PLLU
#define MISC2_CLK_RST_CONTROLLER_PLLU_MISC_0_PLLU_LFCON_RANGE            3: 0
#define MISC1_CLK_RST_CONTROLLER_PLLU_MISC_0_PLLU_CPCON_RANGE            3: 0
// PLLM
...
#define MISC1_CLK_RST_CONTROLLER_PLLM_MISC1_0_PLLM_PD_LSHIFT_PH135_RANGE 30:30
#define MISC1_CLK_RST_CONTROLLER_PLLM_MISC1_0_PLLM_PD_LSHIFT_PH90_RANGE 29:29
#define MISC1_CLK_RST_CONTROLLER_PLLM_MISC1_0_PLLM_PD_LSHIFT_PH45_RANGE 28:28
#define MISC1_CLK_RST_CONTROLLER_PLLM_MISC1_0_PLLM_SETUP_RANGE          23: 0
// PLLX
#define MISC2_CLK_RST_CONTROLLER_PLLX_MISC_3_0_PLLX_KVCO_RANGE           0: 0
#define MISC2_CLK_RST_CONTROLLER_PLLX_MISC_3_0_PLLX_KCP_RANGE            2: 1
#define MISC1_CLK_RST_CONTROLLER_PLLX_MISC_1_0_PLLX_SETUP_RANGE         23: 0
...
#define NVBOOT_CLOCKS_PLLP_OUT0_DIV_TO_408_0_MHZ NVBOOT_CLOCKS_7_1_DIVIDER_BY_1
#define NVBOOT_CLOCKS_PLLP_OUT0_DIV_TO_204_0_MHZ NVBOOT_CLOCKS_7_1_DIVIDER_BY_2
#define NVBOOT_CLOCKS_PLLP_OUT0_DIV_TO_102_0_MHZ NVBOOT_CLOCKS_7_1_DIVIDER_BY_4
...
/* For 15.1 dividers */
/// A 15.1 divider in which lsb denotes 1.0x is the same as as [15:0] divider following
/// N+1 scheme.
#define NVBOOT_CLOCKS_15_1_DIVIDER_BY_20  NVBOOT_CLOCKS_N_DIVIDER_BY(20)
...
/*
 * Enable/Disable the clock to the modules,
 * this corresponds generally to level 1 clock gating
 */
void
NvBootClocksGateClocksLP0BB(NvBool Enable);
