...
static void DoE1853SpecificInitialization(void)
{
#define NV_VDDIO_SDMMC1_ODM_ID NV_ODM_GUID('V','D','D','-','S','D','M','1')

    NvRmDeviceHandle hRm;
    /* NV_VDD_PEX_ODM_ID --> VDD1, NV_VDD_PLL_PEX_ODM_ID-->LDO1 */
 //   NvU64 EnablePowerRailGuidList[] = {NV_VDD_PEX_ODM_ID};
   NvU64 EnablePowerRailGuidList[] = {NV_VDD_PEX_ODM_ID, NV_VPP_FUSE_ODM_ID, NV_VDD_SDIO_ODM_ID, NV_VDDIO_SDMMC1_ODM_ID};
