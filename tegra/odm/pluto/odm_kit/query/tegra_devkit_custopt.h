...
#define TEGRA_DEVKIT_BCT_CUSTOPT_0_POWERSUPPLY_RANGE       23:22
#define TEGRA_DEVKIT_BCT_CUSTOPT_0_POWERSUPPLY_ADAPTER     0
#define TEGRA_DEVKIT_BCT_CUSTOPT_0_POWERSUPPLY_BATTERY     1

#define TEGRA_DEVKIT_BCT_CUSTOPT_0_MODEM_RANGE             7:3
#define TEGRA_DEVKIT_BCT_CUSTOPT_0_MODEM_NONE              0
#define TEGRA_DEVKIT_BCT_CUSTOPT_0_MODEM_I500              1
#define TEGRA_DEVKIT_BCT_CUSTOPT_0_MODEM_I500SWD           2
