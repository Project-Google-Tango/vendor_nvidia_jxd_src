...
// Building for T114 Pluto

static NvPinDrivePingroupConfig pluto_drive_pinmux[] = {
...
static NvPingroupConfig pluto_pinmux_common[] = {
    ...
    /* I2S2 pinmux */
    DEFAULT_PINMUX(DAP3_DIN,      I2S2,    NORMAL,    TRISTATE, ENABLE),
    DEFAULT_PINMUX(DAP3_DOUT,     I2S2,    NORMAL,    NORMAL,   DISABLE),
    DEFAULT_PINMUX(DAP3_FS,       I2S2,    NORMAL,    NORMAL,   DISABLE),
    DEFAULT_PINMUX(DAP3_SCLK,     I2S2,    NORMAL,    NORMAL,   DISABLE),

    /* UARTD pinmux */
    DEFAULT_PINMUX(ULPI_CLK,      UARTD,       NORMAL,    NORMAL,   DISABLE),
    DEFAULT_PINMUX(ULPI_DIR,      UARTD,       NORMAL,    TRISTATE, ENABLE),
    DEFAULT_PINMUX(ULPI_NXT,      UARTD,       NORMAL,    TRISTATE, ENABLE),
    ...
    /* DTV pinmux */
    DEFAULT_PINMUX(GMI_AD14,      DTV,     PULL_DOWN, TRISTATE, ENABLE),
    DEFAULT_PINMUX(GMI_AD15,      DTV,     PULL_DOWN, TRISTATE, ENABLE),
    DEFAULT_PINMUX(GMI_AD8,       DTV,     PULL_DOWN, TRISTATE, ENABLE),
    DEFAULT_PINMUX(GMI_WAIT,      DTV,     PULL_DOWN, TRISTATE, ENABLE),

    /* SPI4 pinmux */
    DEFAULT_PINMUX(GMI_AD5,       SPI4,    NORMAL,    NORMAL,   ENABLE),
    ...
    DEFAULT_PINMUX(GMI_WR_N,      SPI4,    NORMAL,    NORMAL,   ENABLE),
    ...
    /* Backlight and LCD pinmux */
    DEFAULT_PINMUX(GMI_AD10,       GMI,    NORMAL,    NORMAL,   DISABLE),
    DEFAULT_PINMUX(GMI_AD13,       GMI,    NORMAL,    NORMAL,   DISABLE),

    /* SOC pinmux */
    DEFAULT_PINMUX(GMI_CS1_N,     SOC,     PULL_UP,   NORMAL, ENABLE),
    DEFAULT_PINMUX(GMI_OE_N,      SOC,     PULL_UP,   TRISTATE, ENABLE),
    DEFAULT_PINMUX(CLK_32K_OUT,   SOC,     PULL_UP,   TRISTATE, ENABLE),
    ...
    /*  Display pinmux */
    DEFAULT_PINMUX(KB_ROW6,     DISPLAYA_ALT,         NORMAL,    NORMAL,     ENABLE),
    ...
    DEFAULT_PINMUX(GPIO_PU1,      UARTA,       NORMAL,    TRISTATE, ENABLE),
    DEFAULT_PINMUX(GPIO_PU2,      UARTA,       NORMAL,    TRISTATE, ENABLE),
    ...
    /* I2C4 pinmux */
    I2C_PINMUX(DDC_SCL, I2C4, NORMAL, NORMAL, ENABLE, DEFAULT, DEFAULT),
    I2C_PINMUX(DDC_SDA, I2C4, NORMAL, NORMAL, ENABLE, DEFAULT, DEFAULT),
};
...
static NvPingroupConfig pluto_pinmux_avp[] = {
    /* UART D : DEBUG */
    DEFAULT_PINMUX(GMI_A16,     UARTD,       NORMAL,    NORMAL,     DISABLE),
...
NvError NvOdmPinmuxInit(NvU32 BoardId)
{
    ...
    err = NvPinmuxConfigTable(pluto_pinmux_avp, NV_ARRAY_SIZE(pluto_pinmux_avp));
    NV_CHECK_PINMUX_ERROR(err);
#if AVP_PINMUX == 0
    err = NvPinmuxConfigTable(pluto_pinmux_common, NV_ARRAY_SIZE(pluto_pinmux_common));
    NV_CHECK_PINMUX_ERROR(err);

    err = NvPinmuxDriveConfigTable(pluto_drive_pinmux,
       NV_ARRAY_SIZE(pluto_drive_pinmux));
    NV_CHECK_PINMUX_ERROR(err);
