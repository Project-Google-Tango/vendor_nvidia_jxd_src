...
static NvPingroupConfig dalmore_pinmux_common[] = {
	...
	DEFAULT_PINMUX(GMI_AD8,       NAND,        NORMAL,    NORMAL,   ENABLE),
	...
	DEFAULT_PINMUX(GMI_WP_N,      NAND,        NORMAL,    NORMAL,   DISABLE),
	...
	/* I2S0 pinmux */
	DEFAULT_PINMUX(DAP1_DIN,      I2S0,        PULL_DOWN, TRISTATE,   ENABLE),
	...
	/* I2S1 pinmux */
	DEFAULT_PINMUX(DAP2_DIN,      I2S1,        PULL_DOWN, TRISTATE,   ENABLE),
	DEFAULT_PINMUX(DAP2_DOUT,     I2S1,        NORMAL,    NORMAL,   ENABLE),
	DEFAULT_PINMUX(DAP2_FS,       I2S1,        PULL_DOWN, TRISTATE,   ENABLE),
	DEFAULT_PINMUX(DAP2_SCLK,     I2S1,        PULL_DOWN, TRISTATE,   ENABLE),

	/* CLDVFS pinmux */
	DEFAULT_PINMUX(DVFS_PWM,      CLDVFS,      NORMAL,    NORMAL,   ENABLE),
	DEFAULT_PINMUX(DVFS_CLK,      CLDVFS,      NORMAL,    NORMAL,   ENABLE),

	/* I2S2 pinmux */
	DEFAULT_PINMUX(DAP3_DIN,      I2S2,        PULL_DOWN, TRISTATE,   ENABLE),
	...
	/* SPI5 pinmux */
	DEFAULT_PINMUX(ULPI_CLK,      SPI5,        NORMAL,    NORMAL,   ENABLE),
	DEFAULT_PINMUX(ULPI_DIR,      SPI5,        PULL_UP,   TRISTATE,   ENABLE),
	DEFAULT_PINMUX(ULPI_NXT,      SPI5,        NORMAL,    NORMAL,   ENABLE),
	DEFAULT_PINMUX(ULPI_STP,      SPI5,        NORMAL,    NORMAL,   ENABLE),

	/* SPI3 pinmux */
	DEFAULT_PINMUX(ULPI_DATA0,    SPI3,        NORMAL,    NORMAL,   ENABLE),
	DEFAULT_PINMUX(ULPI_DATA1,    SPI3,        PULL_UP,   TRISTATE,   ENABLE),
	...
	DEFAULT_PINMUX(ULPI_DATA5,    SPI2,        PULL_UP,   TRISTATE,   ENABLE),
	...
	/* I2S4 pinmux */
	DEFAULT_PINMUX(GPIO_PBB0,     I2S4,        PULL_DOWN, TRISTATE,   ENABLE),
	DEFAULT_PINMUX(GPIO_PBB7,     I2S4,        NORMAL,    NORMAL,   ENABLE),
	DEFAULT_PINMUX(GPIO_PCC1,     I2S4,        NORMAL,    NORMAL,   ENABLE),
	...
	/* UARTD pinmux */
	DEFAULT_PINMUX(GMI_A16,       UARTD,       NORMAL,    NORMAL,   ENABLE),
	DEFAULT_PINMUX(GMI_A17,       UARTD,       PULL_UP,   TRISTATE,   ENABLE),

	/* NAND pinmux */
	DEFAULT_PINMUX(GMI_AD0,       NAND,        NORMAL,    TRISTATE,   ENABLE),
	DEFAULT_PINMUX(GMI_AD1,       NAND,        NORMAL,    TRISTATE,   ENABLE),
	DEFAULT_PINMUX(GMI_AD10,      NAND,        NORMAL,    TRISTATE,   ENABLE),
	DEFAULT_PINMUX(GMI_AD11,      NAND,        NORMAL,    TRISTATE,   ENABLE),
	DEFAULT_PINMUX(GMI_AD12,      NAND,        NORMAL,    TRISTATE,   ENABLE),
	DEFAULT_PINMUX(GMI_AD13,      NAND,        NORMAL,    TRISTATE,   ENABLE),
	DEFAULT_PINMUX(GMI_AD14,      NAND,        NORMAL,    TRISTATE,   ENABLE),
	DEFAULT_PINMUX(GMI_AD15,      NAND,        NORMAL,    TRISTATE,   ENABLE),
	DEFAULT_PINMUX(GMI_AD2,       NAND,        NORMAL,    TRISTATE,   ENABLE),
	DEFAULT_PINMUX(GMI_AD3,       NAND,        NORMAL,    TRISTATE,   ENABLE),
	DEFAULT_PINMUX(GMI_AD4,       NAND,        NORMAL,    TRISTATE,   ENABLE),
	DEFAULT_PINMUX(GMI_AD5,       NAND,        NORMAL,    TRISTATE,   ENABLE),
	DEFAULT_PINMUX(GMI_AD6,       NAND,        NORMAL,    TRISTATE,   ENABLE),
	DEFAULT_PINMUX(GMI_AD7,       NAND,        NORMAL,    TRISTATE,   ENABLE),
	DEFAULT_PINMUX(GMI_AD8,       NAND,        NORMAL,    TRISTATE,   ENABLE),
	DEFAULT_PINMUX(GMI_AD9,       NAND,        NORMAL,    TRISTATE,   ENABLE),
	DEFAULT_PINMUX(GMI_ADV_N,     NAND,        NORMAL,    NORMAL,   ENABLE),
	DEFAULT_PINMUX(GMI_CLK,       NAND,        NORMAL,    NORMAL,   ENABLE),
	DEFAULT_PINMUX(GMI_CS0_N,     NAND,        NORMAL,    NORMAL,   ENABLE),
	DEFAULT_PINMUX(GMI_OE_N,      NAND,        NORMAL,    NORMAL,   ENABLE),
	DEFAULT_PINMUX(GMI_WAIT,      NAND,        NORMAL,    TRISTATE,   ENABLE),
	DEFAULT_PINMUX(GMI_WP_N,      NAND,        NORMAL,    NORMAL,   ENABLE),
	DEFAULT_PINMUX(GMI_WR_N,      NAND,        NORMAL,    NORMAL,   ENABLE),

	/* USB pinmux */
	DEFAULT_PINMUX(GMI_CS4_N,     USB,         PULL_UP,   TRISTATE,   ENABLE),
	DEFAULT_PINMUX(SPDIF_IN,      USB,         NORMAL,    NORMAL,   ENABLE),
	DEFAULT_PINMUX(USB_VBUS_EN0,  USB,         PULL_UP,   TRISTATE,   ENABLE),

	/* SDMMC1 pinmux */
	DEFAULT_PINMUX(SDMMC1_WP_N,   SDMMC1,      PULL_UP,   TRISTATE,   ENABLE),
	DEFAULT_PINMUX(SDMMC1_CLK,    SDMMC1,      NORMAL,    TRISTATE,   ENABLE),
	DEFAULT_PINMUX(SDMMC1_CMD,    SDMMC1,      PULL_UP,   TRISTATE,   ENABLE),
	DEFAULT_PINMUX(SDMMC1_DAT0,   SDMMC1,      PULL_UP,   TRISTATE,   ENABLE),
	DEFAULT_PINMUX(SDMMC1_DAT1,   SDMMC1,      PULL_UP,   TRISTATE,   ENABLE),
	DEFAULT_PINMUX(SDMMC1_DAT2,   SDMMC1,      PULL_UP,   TRISTATE,   ENABLE),
	DEFAULT_PINMUX(SDMMC1_DAT3,   SDMMC1,      PULL_UP,   TRISTATE,   ENABLE),

	/* SDMMC3 pinmux */
	DEFAULT_PINMUX(SDMMC3_CLK,    SDMMC3,      NORMAL,    NORMAL,   ENABLE),
	DEFAULT_PINMUX(SDMMC3_CMD,    SDMMC3,      PULL_UP,   TRISTATE,   ENABLE),
	DEFAULT_PINMUX(SDMMC3_DAT0,   SDMMC3,      PULL_UP,   TRISTATE,   ENABLE),
	DEFAULT_PINMUX(SDMMC3_DAT1,   SDMMC3,      PULL_UP,   TRISTATE,   ENABLE),
	DEFAULT_PINMUX(SDMMC3_DAT2,   SDMMC3,      PULL_UP,   TRISTATE,   ENABLE),
	DEFAULT_PINMUX(SDMMC3_DAT3,   SDMMC3,      PULL_UP,   TRISTATE,   ENABLE),
	DEFAULT_PINMUX(SDMMC3_CLK_LB_OUT, SDMMC3,      PULL_UP,   TRISTATE,   ENABLE),
	DEFAULT_PINMUX(SDMMC3_CLK_LB_IN, SDMMC3,      PULL_UP,   TRISTATE,   ENABLE),
	DEFAULT_PINMUX(KB_COL4,       SDMMC3,      PULL_UP,   TRISTATE,   ENABLE),
	DEFAULT_PINMUX(SDMMC3_CD_N,   SDMMC3,      PULL_UP,   TRISTATE,   ENABLE),

	/* SDMMC4 pinmux */
	DEFAULT_PINMUX(SDMMC4_CLK,    SDMMC4,      NORMAL,    TRISTATE,   ENABLE),
	DEFAULT_PINMUX(SDMMC4_CMD,    SDMMC4,      PULL_UP,   TRISTATE,   ENABLE),
	DEFAULT_PINMUX(SDMMC4_DAT0,   SDMMC4,      PULL_UP,   TRISTATE,   ENABLE),
	DEFAULT_PINMUX(SDMMC4_DAT1,   SDMMC4,      PULL_UP,   TRISTATE,   ENABLE),
	DEFAULT_PINMUX(SDMMC4_DAT2,   SDMMC4,      PULL_UP,   TRISTATE,   ENABLE),
	DEFAULT_PINMUX(SDMMC4_DAT3,   SDMMC4,      PULL_UP,   TRISTATE,   ENABLE),
	DEFAULT_PINMUX(SDMMC4_DAT4,   SDMMC4,      PULL_UP,   TRISTATE,   ENABLE),
	DEFAULT_PINMUX(SDMMC4_DAT5,   SDMMC4,      PULL_UP,   TRISTATE,   ENABLE),
	DEFAULT_PINMUX(SDMMC4_DAT6,   SDMMC4,      PULL_UP,   TRISTATE,   ENABLE),
	DEFAULT_PINMUX(SDMMC4_DAT7,   SDMMC4,      PULL_UP,   TRISTATE,   ENABLE),
	...
	/* PWRON pinmux */
	DEFAULT_PINMUX(CORE_PWR_REQ,  PWRON,       NORMAL,    NORMAL,   ENABLE),

	/* CPU pinmux */
	DEFAULT_PINMUX(CPU_PWR_REQ,   CPU,         NORMAL,    NORMAL,   ENABLE),

	/* PMI pinmux */
	DEFAULT_PINMUX(PWR_INT_N,     PMI,         NORMAL,    TRISTATE,   ENABLE),

	/* RESET_OUT_N pinmux */
	DEFAULT_PINMUX(RESET_OUT_N,   RESET_OUT_N, NORMAL,    NORMAL,   ENABLE),

	/* EXTPERIPH3 pinmux */
	DEFAULT_PINMUX(CLK3_OUT,      EXTPERIPH3,  NORMAL,    NORMAL,   ENABLE),

	/* I2S3 pinmux */
	DEFAULT_PINMUX(DAP4_DIN,      I2S3,        PULL_DOWN, TRISTATE,   ENABLE),
	...
	/* UARTB pinmux */
	DEFAULT_PINMUX(UART2_CTS_N,   UARTB,       PULL_UP,   TRISTATE,   ENABLE),
	DEFAULT_PINMUX(UART2_RTS_N,   UARTB,       NORMAL,    NORMAL,   ENABLE),

	/* IRDA pinmux */
	DEFAULT_PINMUX(UART2_RXD,     IRDA,        PULL_UP,   TRISTATE,   ENABLE),
	DEFAULT_PINMUX(UART2_TXD,     IRDA,        NORMAL,    NORMAL,   ENABLE),

	/* UARTC pinmux */
	DEFAULT_PINMUX(UART3_CTS_N,   UARTC,       PULL_UP,   TRISTATE,   ENABLE),
	DEFAULT_PINMUX(UART3_RTS_N,   UARTC,       NORMAL,    NORMAL,   ENABLE),
	DEFAULT_PINMUX(UART3_RXD,     UARTC,       PULL_UP,   TRISTATE,   ENABLE),
	DEFAULT_PINMUX(UART3_TXD,     UARTC,       NORMAL,    NORMAL,   ENABLE),
