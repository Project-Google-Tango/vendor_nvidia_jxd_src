...
static NvBool pmuPresented;
static NvBool battPresence;
static NvBool pmuInterruptSupported;
static TPS6586xStatus pmuStatus;
static NvOdmPmuDeviceTPS *hPmu;
...
NvBool Tps6586xPowerOff( NvOdmPmuDeviceHandle  hDevice)
{
    ...
    Tps6586xI2cRead8(hDevice, TPS6586x_R14_SUPPLYENE, &reg_val);

    reg_val = reg_val & ~(EXITSLREQ_BIT);
    Tps6586xI2cWrite8(hDevice, TPS6586x_R14_SUPPLYENE, reg_val);

    reg_val = reg_val | (SLEEP_MODE_BIT);
    Tps6586xI2cWrite8(hDevice, TPS6586x_R14_SUPPLYENE, reg_val);
