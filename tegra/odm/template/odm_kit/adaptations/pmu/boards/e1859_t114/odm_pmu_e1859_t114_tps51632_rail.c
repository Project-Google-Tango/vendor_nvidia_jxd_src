...
static NvOdmPmuRailProps s_OdmTps51632RailProps[] = {
    ...
    {Tps51632PmuSupply_Invalid, E1859PowerRails_Invalid,      0,   0,    0, NV_FALSE, NV_FALSE, NV_FALSE, NULL},
    {Tps51632PmuSupply_VDD,     E1859PowerRails_VDD_CPU,     0,   0, 1100, NV_FALSE, NV_FALSE, NV_FALSE, &s_tps51632_bdata},
};
...
{
        pRailMap[E1859PowerRails_VDD_CPU] = Tps51632PmuSupply_VDD;
}
