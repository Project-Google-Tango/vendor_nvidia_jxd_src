...
static NvOdmPmuRailProps s_OdmTps51632RailProps[] = {
    ...
    {Tps51632PmuSupply_Invalid, ArdbegPowerRails_Invalid,      0,   0,    0, NV_FALSE, NV_FALSE, NV_FALSE, NULL},
    {Tps51632PmuSupply_VDD,     ArdbegPowerRails_VDD_CPU,     0,   0, 1100, NV_FALSE, NV_FALSE, NV_FALSE, &s_tps51632_bdata},
};
...
{
        pRailMap[ArdbegPowerRails_VDD_CPU] = Tps51632PmuSupply_VDD;
}
    ...
    NvOdmBoardInfo *pPmuBoard)
{
    ...
    if (!hPmuDriver)
    {
        NvOdmOsPrintf("%s():Tps51632PmuDriverOpen() fail\n", __func__);
        return NULL;
    }
