...
static const NvU8
s_NvOdmQueryPlatformSetting[] = {'E','1','8','5','9',0};
...
static const NvOdmQuerySdioInterfaceProperty s_NvOdmQuerySdioInterfaceProperty[] =
{
    ...
    { NV_TRUE,  10, NV_TRUE,  2, 3, NvOdmQuerySdioSlotUsage_wlan},
    { NV_FALSE, 10, NV_FALSE, 3, 3, NvOdmQuerySdioSlotUsage_Media},
    { NV_TRUE,  10, NV_TRUE,  5, 3, NvOdmQuerySdioSlotUsage_Boot},
};
...
{
    return ( (GetBctKeyValue()) >> 31); // Bit 31 reserved for HDMI display info
}
