...
static const NvU8
s_NvOdmQueryPlatformSetting[] = {'M','2','6','0','1',0};
...
//TODO:: Check if these values are valid for embedded platforms
...
NvOdmQueryModuleInterfaceCaps(
    ...
    void *pCaps)
{
    // FIXME::This function is necessary while using Kernel pinmux.
    // Providing stub implementation temporarily.
    // Please see bug 1051971
