###########################################################
## Track prebuilt NOTICE files
## It's an adaptation from original file in:
## $TOP/build/core/notice_files.mk
###########################################################

# Notice file for prebuilt module is defined as LOCAL_PREBUILT_NOTICE_FILE
# relative to LOCAL_PATH.
# This makefile fragment is included from macro generated by release scripts
#
notice_file:=$(addprefix $(TOP_DIR)$(LOCAL_PATH)/,$(LOCAL_PREBUILT_NOTICE_FILE))
...
ifneq ($(strip $(wildcard $(notice_file))),)
